...
class ServerRepository:
    ...
    def __init__(
        ...
        udpPort: object = None,
        dcFileNames: Iterable[str | bytes | PathLike] | None = None,
    ...
    def readDCFile(self, dcFileNames: Iterable[str | bytes | PathLike] | None = None) -> None: ...
    ...
    def sendToZoneExcept(self, zoneId: int, datagram: NetDatagram, exceptionList: Collection[ServerRepository.Client]) -> None: ...
