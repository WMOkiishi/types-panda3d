...
class DistributedSmoothNodeAI(DistributedNodeAI, DistributedSmoothNodeBase):
    ...
    def setSmStop(self, t: Unused = None) -> None: ...
    def setSmH(self, h: float, t: Unused = None) -> None: ...
    def setSmZ(self, z: float, t: Unused = None) -> None: ...
    def setSmXY(self, x: float, y: float, t: Unused = None) -> None: ...
    def setSmXZ(self, x: float, z: float, t: Unused = None) -> None: ...
    def setSmPos(self, x: float, y: float, z: float, t: Unused = None) -> None: ...
    def setSmHpr(self, h: float, p: float, r: float, t: Unused = None) -> None: ...
    def setSmXYH(self, x: float, y: float, h: float, t: Unused = None) -> None: ...
    def setSmXYZH(self, x: float, y: float, z: float, h: float, t: Unused = None) -> None: ...
    def setSmPosHpr(self, x: float, y: float, z: float, h: float, p: float, r: float, t: Unused = None) -> None: ...
    def setSmPosHprL(self, l: Unused, x: float, y: float, z: float, h: float, p: float, r: float, t: Unused = None) -> None: ...
