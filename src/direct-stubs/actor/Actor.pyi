...
class Actor(DirectObject, NodePath):
    ...
    allowAsyncBind: bool
    switches = ...
    gotName: bool | _OldBool
    class PartDef:
        partBundleNP: NodePath[Character]
        partBundleHandle: PartBundleHandle
        partModel = ...
        def __init__(self, partBundleNP: NodePath[Character], partBundleHandle: PartBundleHandle, partModel) -> None: ...
    ...
    class AnimDef:
        ...
        def __init__(self, filename = None, animBundle = None) -> None: ...
    ...
    def add_lod(self, lodName: str, inDist: float = 0, outDist: float = 0, center: _Vec3f | None = None) -> None: ...
    ...
    def has_lod(self) -> _OldBool: ...
    def set_center(self, center: _Vec3f | None) -> None: ...
    ...
    def get_joint_transform(self, partName: str, jointName: str, lodName: str = 'lodRoot'): ...
    def get_joint_transform_state(self, partName: str, jointName: str, lodName: str = 'lodRoot'): ...
    def control_joint(self, partName: str, jointName: str, lodName: str = 'lodRoot') -> NodePath[ModelNode]: ...
    def freeze_joint(
        self,
        partName: str,
        jointName: str,
    ...
    def get_anim_filename(self, animName: str, partName: str = 'modelRoot'): ...
    ...
    def load_model(
        self,
        modelPath: NodePath | str | bytes | PathLike,
    ...
    def verify_subparts_complete(self, partName: str | None = None, lodName: str | None = None): ...
    ...
    def actor_interval(self, *args, **kw): ...
    def get_anim_blends(
        self,
        animName: str | None = None,
        partName: str | None = None,
