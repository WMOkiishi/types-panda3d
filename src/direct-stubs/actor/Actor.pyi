...
class Actor(DirectObject, NodePath):
    ...
    def add_lod(self, lodName: str, inDist: float = ..., outDist: float = ..., center: Vec3f | None = None) -> None: ...
    ...
    def set_center(self, center: Vec3f | None) -> None: ...
    def set_lod_animation(self, farDistance: float, nearDistance: float, delayFactor: float) -> None: ...
    def clear_lod_animation(self) -> None: ...
    def update(self, lod: int = ..., partName: str | None = None, lodName: str | None = None, force: bool = False) -> bool: ...
