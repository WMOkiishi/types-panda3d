...
class TexMemWatcher(DirectObject):
    ...
    def enterRegion(self, region: DisplayRegion, buttonName: object) -> None: ...
    def leaveRegion(self, region: DisplayRegion, buttonName: object) -> None: ...
    def mouseClick(self) -> None: ...
    def setRollover(self, tr: TexRecord, pi: object) -> None: ...
    ...
    def findEmptyRuns(self, bm) -> set[tuple[int, int]]: ...
