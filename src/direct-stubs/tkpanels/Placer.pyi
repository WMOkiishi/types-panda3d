...
class Placer(AppShell):
    ...
    def updatePosWidgets(self, pos: Vec3Like | tuple[float, float, float]) -> None: ...
    def updateHprWidgets(self, hpr: Vec3Like | tuple[float, float, float]) -> None: ...
    def updateScaleWidgets(self, scale: Vec3Like | tuple[float, float, float]) -> None: ...
