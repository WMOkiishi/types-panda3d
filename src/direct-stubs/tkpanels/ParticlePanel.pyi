...
class ParticlePanel(AppShell):
    ...
    def setSystemPos(self, pos: Vec3f | tuple[float, float, float]) -> None: ...
    def setSystemHpr(self, pos: Vec3f | tuple[float, float, float]) -> None: ...
    ...
    def setEmitterOffsetForce(self, vec: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterRadiateOrigin(self, origin: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterExplicitLaunchVector(self, vec: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterBoxPoint1(self, point: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterBoxPoint2(self, point: Vec3f | tuple[float, float, float]) -> None: ...
    ...
    def setEmitterLinePoint1(self, point: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterLinePoint2(self, point: Vec3f | tuple[float, float, float]) -> None: ...
    def setEmitterPointPosition(self, pos: Vec3f | tuple[float, float, float]) -> None: ...
