...
from panda3d.core import LColor, LVecBase2f
...
class ParticlePanel(AppShell):
    ...
    def setSystemPos(self, pos: Vec3Like | tuple[float, float, float]) -> None: ...
    def setSystemHpr(self, pos: Vec3Like | tuple[float, float, float]) -> None: ...
    ...
    def setEmitterOffsetForce(self, vec: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterRadiateOrigin(self, origin: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterExplicitLaunchVector(self, vec: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterBoxPoint1(self, point: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterBoxPoint2(self, point: Vec3Like | tuple[float, float, float]) -> None: ...
    ...
    def setEmitterLinePoint1(self, point: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterLinePoint2(self, point: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterPointPosition(self, pos: Vec3Like | tuple[float, float, float]) -> None: ...
    def setEmitterRectanglePoint1(self, point: LVecBase2f | tuple[float, float]) -> None: ...
    def setEmitterRectanglePoint2(self, point: LVecBase2f | tuple[float, float]) -> None: ...
    ...
    def setRendererLineHeadColor(self, color: LColor | tuple[float, float, float, float]) -> None: ...
    def setRendererLineTailColor(self, color: LColor | tuple[float, float, float, float]) -> None: ...
