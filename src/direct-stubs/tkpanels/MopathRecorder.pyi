...
class MopathRecorder(AppShell, DirectObject):
    ...
    def curveEditTask(self, state: _Unused) -> Literal[1]: ...
    def manipulateObjectStartHook(self) -> None: ...
    def manipulateObjectCleanupHook(self, nodePathList: _Unused = ...) -> None: ...
    ...
    def setPathColor(self, color: LVecBase3f | tuple[float, float, float]) -> None: ...
    def setKnotColor(self, color: LVecBase3f | tuple[float, float, float]) -> None: ...
    def setCvColor(self, color: LVecBase3f | tuple[float, float, float]) -> None: ...
    def setTickColor(self, color: LVecBase3f | tuple[float, float, float]) -> None: ...
    def setHullColor(self, color: LVecBase3f | tuple[float, float, float]) -> None: ...
    ...
    def easeInOut(self, t: _AnyReal) -> _AnyReal: ...
