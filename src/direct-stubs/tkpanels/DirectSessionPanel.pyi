...
class DirectSessionPanel(AppShell):
    ...
    def setBackgroundColorVec(self, color: Vec3Like | tuple[float, float, float]) -> None: ...
    ...
    def setLightColor(self, color: Vec3Like | tuple[float, float, float, float]) -> None: ...
    def setSpecularColor(self, color: Vec3Like | tuple[float, float, float, float]) -> None: ...
