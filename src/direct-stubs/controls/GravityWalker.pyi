...
class GravityWalker(DirectObject):
    ...
    def setupRay(self, bitmask: BitMask_uint32_t_32, floorOffset: float, reach: float) -> None: ...
    ...
    def getGravity(self, gravity: _Unused) -> float: ...
    ...
    def setAirborneHeightFunc(self, unused_parameter: _Unused) -> None: ...
    ...
    def setMayJump(self, task: _Unused) -> Literal[1]: ...
