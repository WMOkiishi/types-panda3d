...
class DialWidget(Pmw.MegaWidget):
    ...
    def mouseMotion(self, event, fShift: bool = False) -> None: ...
    def computeDialAngle(self, event, fShift: bool = False) -> float: ...
    def computValueFromAngle(self, dialAngle: float) -> None: ...
