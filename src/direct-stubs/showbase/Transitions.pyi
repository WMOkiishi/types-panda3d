...
class Transitions:
    ...
    def getFadeInIval(
        self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...
    ) -> MetaInterval.Sequence: ...
    def getFadeOutIval(
        self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...
    ) -> MetaInterval.Sequence: ...
    def fadeIn(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
    def fadeOut(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
    ...
    def irisIn(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
    def irisOut(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
    def noIris(self) -> None: ...
    def noTransitions(self) -> None: ...
    def loadLetterbox(self) -> None: ...
    def noLetterbox(self) -> None: ...
    def letterboxOn(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
    def letterboxOff(self, t: float = ..., finishIval: _Interval | None = None, blendType: _BlendType = ...) -> AsyncFuture: ...
