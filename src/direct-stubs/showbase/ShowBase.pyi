...
class ShowBase(DirectObject):
    ...
    def playMusic(
        self, music: AudioSound, looping: bool = False, interrupt: bool = True, volume: float | None = None, time: float = ...
    ) -> None: ...
    ...
    def set_background_color(
        self, r: LColor | LRGBColor, g: None = None, b: None = None, a: float = ..., win: GraphicsEngine | None = None
    ) -> None: ...
    @overload
    ...
    def screenshot(
        self, namePrefix: str = ..., defaultFilename: bool = True, source: GraphicsEngine | None = None, imageComment: str = ...
    ) -> str | None: ...
    def save_cube_map(
        self,
        namePrefix: str = ...,
