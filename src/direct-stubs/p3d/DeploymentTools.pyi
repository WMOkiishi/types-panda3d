...
class Standalone:
    ...
    host: HostInfo
    http: HTTPClient
    def __init__(self, p3dfile: _Filename, tokens: Mapping = ...) -> None: ...
...
class PackageTree:
    ...
    hostDir: Filename
    http: HTTPClient
    def __init__(self, platform: str, hostDir: _Filename, hostUrl: str) -> None: ...
...
class Installer:
    ...
    def __del__(self) -> None: ...
    def installPackagesInto(self, hostDir: _Filename, platform: str) -> None: ...
    def buildAll(self, outputDir: str = '.') -> None: ...
    def build(self, output: _Filename, platform: str | None = None) -> None: ...
    def buildDEB(self, output: _Filename, platform: str) -> Filename: ...
    def buildArch(self, output: _Filename, platform: str) -> Filename: ...
    def buildAPP(self, output: _Filename, platform: str) -> Filename: ...
    def buildPKG(self, output: _Filename, platform: str) -> Filename: ...
    def buildNSIS(self, output: _Filename, platform: str) -> Filename: ...
