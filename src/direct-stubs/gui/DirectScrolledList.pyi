...
class DirectScrolledList(DirectFrame):
    ...
    def scrollTo(self, index: int, centered: bool = False) -> _OldBool: ...
    def makeAllItems(self) -> None: ...
    def addItem(self, item: DirectScrolledListItem | str, refresh: bool = True): ...
    def removeItem(self, item: DirectScrolledListItem | str, refresh: bool = True) -> _OldBool: ...
    def removeAndDestroyItem(self, item: DirectScrolledListItem, refresh: bool = True) -> _OldBool: ...
    def removeAllItems(self, refresh: bool = True) -> _OldBool: ...
    def removeAndDestroyAllItems(self, refresh: bool = True) -> _OldBool: ...
