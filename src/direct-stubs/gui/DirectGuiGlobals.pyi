...
from panda3d.core import AudioSound, TextFont

_PGFrameStyle_Type: TypeAlias = Literal[0, 1, 2, 3, 4, 5, 6]

defaultFont: TextFont | None
defaultFontFunc: Callable[[], TextFont]
defaultClickSound: AudioSound | None
defaultRolloverSound: AudioSound | None
...
def get_default_rollover_sound() -> AudioSound | None: ...
def set_default_rollover_sound(newSound: AudioSound | None) -> None: ...
def get_default_click_sound() -> AudioSound | None: ...
def set_default_click_sound(newSound: AudioSound | None) -> None: ...
