...
class NewStyle(FSM):
    def enterRed(self) -> None: ...
    @overload
    def filterRed(self, request: Literal['advance'], args: Unused) -> Literal['Green']: ...  # type: ignore[overload-overlap]
    @overload
    def filterRed(self, request: str, args: tuple[Unpack[_T]]) -> tuple[str, Unpack[_T]] | None: ...
    def exitRed(self) -> None: ...
    def enterYellow(self) -> None: ...
    @overload
    def filterYellow(self, request: Literal['advance'], args: Unused) -> Literal['Red']: ...  # type: ignore[overload-overlap]
    @overload
    def filterYellow(self, request: str, args: tuple[Unpack[_T]]) -> tuple[str, Unpack[_T]] | None: ...
    def exitYellow(self) -> None: ...
    def enterGreen(self) -> None: ...
    @overload
    def filterGreen(self, request: Literal['advance'], args: Unused) -> Literal['Yellow']: ...  # type: ignore[overload-overlap]
    @overload
