...
class Interval(DirectObject):
    ...
    openEnded: bool | _OldBool
    open_ended: bool | _OldBool
    play_rate: float
    done_event: str
    def __init__(self, name: str, duration: float, openEnded: bool = True) -> None: ...
    def getName(self) -> str: ...
    def getDuration(self) -> float: ...
    def getOpenEnded(self) -> bool | _OldBool: ...
    def setLoop(self, loop: bool = True) -> None: ...
    def getLoop(self) -> bool | _OldBool: ...
    def getState(self) -> _State: ...
    def isPaused(self) -> bool: ...
    def isStopped(self) -> bool: ...
    def setT(self, t: float) -> None: ...
    def getT(self) -> float: ...
    def start(self, startT: float = 0, endT: float = -1, playRate: float = 1) -> PythonTask: ...
    ...
    def stepPlay(self) -> bool | _OldBool: ...
    @property
