...
from typing_extensions import Final, Never, TypeAlias
...
class ExternalThread(ThreadBase):
    ...
    def join(self, timeout: _Unused = None) -> NoReturn: ...
    def setDaemon(self, daemon: _Unused) -> NoReturn: ...
...
def stack_size(size: _Unused = None) -> NoReturn: ...
