...
class DirectNodePath(NodePath):
    ...
    def __init__(self, nodePath: NodePath, bboxColor: Vec4f | None = None) -> None: ...
    def highlight(self, fRecompute: bool = True) -> None: ...
...
class SelectedNodePaths(DirectObject):
    ...
    def reset(self) -> None: ...
    def select(
        self, nodePath: DirectNodePath | None, fMultiSelect: bool = False, fSelectTag: bool = True
    ) -> DirectNodePath | None: ...
...
class DirectBoundingBox:
    ...
    def createBBoxLines(self, bboxColor: Vec4f | None = None) -> LineNodePath: ...
...
class SelectionRay(SelectionQueue):
    ...
    def pickBitMask(
        self, bitMask: BitMask32 = ..., targetNodePath: NodePath | None = None, skipFlags: int = ...
    ) -> CollisionEntry: ...
    def pickGeom(
        self, targetNodePath: NodePath | None = None, skipFlags: int = ..., xy: Sequence[float] | None = None
    ) -> CollisionEntry: ...
    def pickWidget(self, targetNodePath: NodePath | None = None, skipFlags: int = ...) -> CollisionEntry: ...
    def pick3D(self, targetNodePath: NodePath, origin: Vec3f, dir: Vec3f) -> None: ...
    def pickGeom3D(
        self, targetNodePath: NodePath | None = None, origin: Vec3f = ..., dir: Vec3f = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...
    def pickBitMask3D(
        self,
        bitMask: BitMask32 = ...,
...
class SelectionSegment(SelectionQueue):
    ...
    def pickGeom(
        self, targetNodePath: NodePath | None = None, endPointList: Sequence = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...
    def pickBitMask(
        self, bitMask: BitMask32 = ..., targetNodePath: NodePath | None = None, endPointList: Sequence = ..., skipFlags: int = ...
    ) -> CollisionEntry: ...

class SelectionSphere(SelectionQueue):
    colliders: list[CollisionSolid]
    numColliders: int
    def __init__(self, parentNP: NodePath | None = None, numSpheres: int = ...) -> None: ...
