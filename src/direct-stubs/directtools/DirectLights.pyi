...
class DirectLights(NodePath[PandaNode]):
    ...
    @overload
    def create(self, ltype: Literal['ambient']) -> DirectLight[AmbientLight]: ...  # type: ignore[overload-overlap]
    @overload
    def create(self, ltype: Literal['directional']) -> DirectLight[DirectionalLight]: ...  # type: ignore[overload-overlap]
    @overload
    def create(self, ltype: Literal['point']) -> DirectLight[PointLight]: ...  # type: ignore[overload-overlap]
    @overload
    def create(self, ltype: Literal['spot']) -> DirectLight[Spotlight]: ...  # type: ignore[overload-overlap]
    @overload
    def create(self, ltype: str) -> None: ...
