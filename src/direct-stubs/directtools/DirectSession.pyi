...
class DirectSession(DirectObject):
    ...
    def widgetResizeTask(self, state: _Unused) -> Literal[1]: ...
    def select(
        self,
        nodePath: NodePath,
    ...
    def pushUndo(self, nodePathList: Iterable[NodePath], fResetRedo: bool = True) -> None: ...
    ...
    def hideDirectMessage(self, state: _Unused) -> Literal[0]: ...
...
class DisplayRegionContext(DirectObject):
    ...
    def camUpdate(self, lens: _Unused = None) -> None: ...
...
class DisplayRegionList(DirectObject):
    ...
    def contextTask(self, state: _Unused) -> Literal[1]: ...
