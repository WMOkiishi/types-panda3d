...
class DirectSession(DirectObject):
    ...
    def widgetResizeTask(self, state) -> Literal[1]: ...
    def select(
        self,
        nodePath: NodePath,
    ...
    def followSelectedNodePathTask(self, state) -> Literal[1]: ...
    ...
    def pushUndo(self, nodePathList, fResetRedo: bool = True) -> None: ...
    def popUndoGroup(self): ...
    def pushRedo(self, nodePathList) -> None: ...
    def popRedoGroup(self): ...
    def undo(self) -> None: ...
    def redo(self) -> None: ...
    def message(self, text: str) -> None: ...
    def hideDirectMessageLater(self) -> None: ...
    def hideDirectMessage(self, state: object) -> Literal[0]: ...
...
class DisplayRegionContext(DirectObject):
    ...
    def camUpdate(self, lens: object = None) -> None: ...
...
class DisplayRegionList(DirectObject):
    ...
    def contextTask(self, state: object) -> Literal[1]: ...
