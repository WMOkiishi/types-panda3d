...
class DirectManipulationControl(DirectObject):
    ...
    def switchToMoveMode(self, state: _Unused) -> Literal[0]: ...
    ...
    def disableManipulation(self, allowSelectionOnly: bool = False) -> None: ...
    ...
    def xlate1D(self, state: _Unused) -> None: ...
    def xlate2D(self, state: _Unused) -> None: ...
    def rotate1D(self, state: _Unused) -> None: ...
    def widgetCheck(self, type: str) -> bool | None: ...
    def xlateCamXZ(self, state: _Unused) -> None: ...
    def xlateCamXY(self, state: _Unused) -> None: ...
    def rotate2D(self, state: Task) -> None: ...
    def rotateAboutViewVector(self, state: Task) -> None: ...
    def scale1D(self, state: _Unused) -> None: ...
    def scale3D(self, state: _Unused) -> None: ...
