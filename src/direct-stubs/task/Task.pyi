...
class TaskManager:
    ...
    def invokeDefaultHandler(self, signalNumber: _Unused, stackFrame: _Unused) -> NoReturn: ...
    def keyboardInterruptHandler(self, signalNumber: _Unused, stackFrame: _Unused) -> None: ...
    ...
    def doYield(self, frameStartTime: _Unused, nextScheduledTaskTime: _Unused) -> None: ...
