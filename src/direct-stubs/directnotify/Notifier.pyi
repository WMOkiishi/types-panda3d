from typing import ClassVar, NoReturn, SupportsInt, SupportsRound
...
class Notifier:
    ...
    def error(self, errorString: object, exception: type[Exception] = Exception) -> NoReturn: ...
    ...
    def getLogging(self): ...
    def setLogging(self, bool: bool): ...
    def debugStateCall(self, obj = None, fsmMemberName: str = 'fsm', secondaryFsm: str = 'secondaryFSM') -> Literal[1]: ...
