...
class EggXfmSAnim(EggGroupNode):
    ...
    @overload
    def __init__(self, convert_from: EggXfmAnimData | EggXfmSAnim) -> None: ...
    @overload
    def __init__(self, copy: EggXfmAnimData | EggXfmSAnim) -> None: ...
    def assign(self, copy: EggXfmAnimData | EggXfmSAnim) -> EggXfmSAnim: ...
    def set_fps(self, fps: float) -> None: ...
    def clear_fps(self) -> None: ...
    def has_fps(self) -> bool: ...
    def get_fps(self) -> float:
...
class EggXfmAnimData(EggAnimData):
    ...
    @overload
    def __init__(self, convert_from: EggXfmAnimData | EggXfmSAnim) -> None: ...
    def assign(self, copy: EggXfmAnimData | EggXfmSAnim) -> EggXfmAnimData: ...
    def set_order(self, order: str) -> None: ...
    def clear_order(self) -> None: ...
    def has_order(self) -> bool: ...
    def get_order(self) -> str: ...
