...
from panda3d.core import BamCacheRecord, ConfigVariableFilename, PandaNode
...
def load_egg_file(filename: _Filepath, cs: _CoordinateSystem = ..., record: BamCacheRecord = ...) -> PandaNode: ...
def load_egg_data(data: EggData, cs: _CoordinateSystem = ...) -> PandaNode: ...
def save_egg_file(filename: _Filepath, node: PandaNode, cs: _CoordinateSystem = ...) -> bool: ...
