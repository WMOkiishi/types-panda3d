...
class BulletRayHit:
    ...
    @property
    def hit_pos(self) -> LPoint3f: ...
    @property
    def hit_normal(self) -> LVector3f: ...
    @property
    ...
    def get_hit_pos(self) -> LPoint3f: ...
    def get_hit_normal(self) -> LVector3f: ...
...
class BulletAllHitsRayResult:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @property
    def from_pos(self) -> LPoint3f: ...
    @property
    def to_pos(self) -> LPoint3f: ...
    @property
    ...
    def empty() -> BulletAllHitsRayResult:
        ...
        """
        ...
    def get_from_pos(self) -> LPoint3f: ...
    def get_to_pos(self) -> LPoint3f: ...
...
class BulletBodyNode(PandaNode):
    ...
    restitution: float
    friction: float
    anisotropic_friction: LVecBase3f
    ccd_swept_sphere_radius: float
    ccd_motion_threshold: float
    @property
    def shapes(self) -> Sequence[BulletShape]: ...
    @property
    def shape_pos(self) -> Sequence[LPoint3f]: ...
    @property
    def shape_mat(self) -> Sequence[LMatrix4f]: ...
    @property
    ...
    def get_shape_pos(self, idx: int) -> LPoint3f: ...
    def get_shape_mat(self, idx: int) -> LMatrix4f: ...
    ...
    def get_anisotropic_friction(self) -> LVecBase3f: ...
...
class BulletBoxShape(BulletShape):
    ...
    @property
    def half_extents_without_margin(self) -> LVecBase3f: ...
    @overload
...
class BulletRigidBodyNode(BulletBodyNode):
    ...
    angular_velocity: LVector3f
    linear_damping: float
    angular_damping: float
    linear_sleep_threshold: float
    angular_sleep_threshold: float
    gravity: LVector3f
    linear_factor: LVector3f
    angular_factor: LVector3f
    @property
    def inv_mass(self) -> float: ...
    @property
    def inv_inertia_diag_local(self) -> LVector3f: ...
    @property
    def inv_inertia_tensor_world(self) -> LMatrix3f: ...
    @property
    def total_force(self) -> LVector3f: ...
    @property
    def total_torque(self) -> LVector3f: ...
    ...
    def set_inertia(self, inertia: Vec3f) -> None:
        ...
        """
        ...
    def get_inertia(self) -> LVector3f:
        ...
        """
        ...
    def get_inv_inertia_diag_local(self) -> LVector3f: ...
    def get_inv_inertia_tensor_world(self) -> LMatrix3f: ...
    def get_linear_velocity(self) -> LVector3f:
        """Velocity"""
        ...
    def get_angular_velocity(self) -> LVector3f: ...
    ...
    def get_total_force(self) -> LVector3f: ...
    def get_total_torque(self) -> LVector3f: ...
    ...
    def set_gravity(self, gravity: Vec3f) -> None:
        """Gravity"""
        ...
    def get_gravity(self) -> LVector3f: ...
    def get_linear_factor(self) -> LVector3f:
        """Restrict movement"""
        ...
    def get_angular_factor(self) -> LVector3f: ...
...
class BulletManifoldPoint:
    ...
    lateral_friction_dir1: LVector3f
    lateral_friction_dir2: LVector3f
    ...
    @property
    def position_world_on_a(self) -> LPoint3f: ...
    @property
    def position_world_on_b(self) -> LPoint3f: ...
    @property
    def normal_world_on_b(self) -> LVector3f: ...
    @property
    def local_point_a(self) -> LPoint3f: ...
    @property
    def local_point_b(self) -> LPoint3f: ...
    @property
    ...
    def get_applied_impulse(self) -> float: ...
    def get_position_world_on_a(self) -> LPoint3f: ...
    def get_position_world_on_b(self) -> LPoint3f: ...
    def get_normal_world_on_b(self) -> LVector3f: ...
    def get_local_point_a(self) -> LPoint3f: ...
    def get_local_point_b(self) -> LPoint3f: ...
    ...
    def get_lateral_friction_dir1(self) -> LVector3f: ...
    def get_lateral_friction_dir2(self) -> LVector3f: ...
...
class BulletSoftBodyNode(BulletBodyNode):
    ...
    def get_wind_velocity(self) -> LVector3f: ...
    ...
    def cluster_com(self, cluster: int) -> LVecBase3f: ...
    ...
    @overload
    @staticmethod
    def make_tri_mesh(info: BulletSoftBodyWorldInfo, points: PointerToArray_LVecBase3f, indices: PointerToArray_int, randomizeConstraints: bool = ...) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
    def make_tet_mesh(info: BulletSoftBodyWorldInfo, points: PointerToArray_LVecBase3f, indices: PointerToArray_int, tetralinks: bool = ...) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
...
class BulletSoftBodyWorldInfo:
    ...
    def get_water_normal(self) -> LVector3f: ...
    def get_gravity(self) -> LVector3f: ...
...
class BulletVehicle(TypedReferenceCount):
    ...
    @property
    def forward_vector(self) -> LVector3f: ...
    @property
    ...
    def get_steering_value(self, idx: int) -> float:
        ...
        ...
    def get_forward_vector(self) -> LVector3f:
...
class BulletWheel:
    ...
    chassis_connection_point_cs: LPoint3f
    wheel_direction_cs: LVector3f
    wheel_axle_cs: LVector3f
    world_transform: LMatrix4f
    front_wheel: bool
    node: PandaNode
    @property
    ...
    def get_chassis_connection_point_cs(self) -> LPoint3f:
        """Returns the point where the wheel is connected to the chassis."""
        ...
    def get_wheel_direction_cs(self) -> LVector3f:
        """Returns the wheel's forward vector relative to the chassis."""
        ...
    def get_wheel_axle_cs(self) -> LVector3f:
        """Returns the normal vector of the wheel axle."""
        ...
    def get_world_transform(self) -> LMatrix4f: ...
...
class BulletWheelRaycastInfo:
    ...
    @property
    def contact_normal_ws(self) -> LVector3f: ...
    @property
    def wheel_direction_ws(self) -> LVector3f: ...
    @property
    def wheel_axle_ws(self) -> LVector3f: ...
    @property
    def contact_point_ws(self) -> LPoint3f: ...
    @property
    def hard_point_ws(self) -> LPoint3f: ...
    @property
    ...
    def get_contact_normal_ws(self) -> LVector3f: ...
    def get_wheel_direction_ws(self) -> LVector3f: ...
    def get_wheel_axle_ws(self) -> LVector3f: ...
    def get_contact_point_ws(self) -> LPoint3f: ...
    def get_hard_point_ws(self) -> LPoint3f: ...
...
class BulletWorld(TypedReferenceCount):
    ...
    def ray_test_closest(self, from_pos: Vec3f, to_pos: Vec3f, mask: BitMask_uint32_t_32 = ...) -> BulletClosestHitRayResult:
        """Raycast and other queries"""
        ...
    def ray_test_all(self, from_pos: Vec3f, to_pos: Vec3f, mask: BitMask_uint32_t_32 = ...) -> BulletAllHitsRayResult: ...
    def sweep_test_closest(self, shape: BulletShape, from_ts: TransformState, to_ts: TransformState, mask: BitMask_uint32_t_32 = ..., penetration: float = ...) -> BulletClosestHitSweepResult:
...
class BulletConvexPointCloudShape(BulletShape):
    ...
    @overload
    def __init__(self, points: PointerToArray_LVecBase3f, scale: Vec3f = ...) -> None: ...
...
class BulletTranslationalLimitMotor:
    ...
    @property
    def current_diff(self) -> LPoint3f: ...
    @property
    def accumulated_impulse(self) -> LVector3f: ...
    ...
    def get_current_limit(self, axis: int) -> int:
        ...
        """
        ...
    def get_current_error(self) -> LVector3f: ...
    def get_current_diff(self) -> LPoint3f: ...
    def get_accumulated_impulse(self) -> LVector3f: ...
    setMotorEnabled = set_motor_enabled
    setLowLimit = set_low_limit
    setHighLimit = set_high_limit
    setTargetVelocity = set_target_velocity
...
class BulletMultiSphereShape(BulletShape):
    ...
    @property
    def sphere_pos(self) -> Sequence[LPoint3f]: ...
    @property
...
class BulletPlaneShape(BulletShape):
    ...
    @property
    def plane_normal(self) -> LVector3f: ...
    @property
    ...
    def get_plane_normal(self) -> LVector3f: ...
