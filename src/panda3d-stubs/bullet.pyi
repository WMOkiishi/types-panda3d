...
class BulletBodyNode(PandaNode):
    ...
    def set_anisotropic_friction(self, friction: _Vec3f) -> None: ...
...
class BulletCharacterControllerNode(BulletBaseCharacterControllerNode):
    ...
    def set_linear_movement(self, velocity: _Vec3f, is_local: bool) -> None: ...
...
class BulletRigidBodyNode(BulletBodyNode):
    ...
    def get_inv_mass(self) -> float:
        ...
        ...
    def set_inertia(self, inertia: _Vec3f) -> None:
    ...
    def set_linear_velocity(self, velocity: _Vec3f) -> None: ...
    def set_angular_velocity(self, velocity: _Vec3f) -> None: ...
    ...
    def clear_forces(self) -> None:
        """Forces"""
        ...
    def apply_force(self, force: _Vec3f, pos: _Vec3f) -> None: ...
    def apply_central_force(self, force: _Vec3f) -> None: ...
    def apply_impulse(self, impulse: _Vec3f, pos: _Vec3f) -> None: ...
    def apply_central_impulse(self, impulse: _Vec3f) -> None: ...
    def apply_torque(self, torque: _Vec3f) -> None: ...
    def apply_torque_impulse(self, torque: _Vec3f) -> None: ...
    ...
    def set_linear_factor(self, factor: _Vec3f) -> None: ...
    def set_angular_factor(self, factor: _Vec3f) -> None: ...
...
class BulletConeTwistConstraint(BulletConstraint):
    ...
    def set_motor_target(self, quat: _Vec4f) -> None: ...
    def set_motor_target_in_constraint_space(self, quat: _Vec4f) -> None: ...
...
class BulletManifoldPoint:
    ...
    def set_lateral_friction_dir1(self, dir: _Vec3f) -> None: ...
    def set_lateral_friction_dir2(self, dir: _Vec3f) -> None: ...
...
class BulletSoftBodyNode(BulletBodyNode):
    ...
    @overload
    def add_force(self, force: _Vec3f) -> None: ...
    @overload
    def add_force(self, force: _Vec3f, node: int) -> None: ...
    def set_velocity(self, velocity: _Vec3f) -> None: ...
    @overload
    def add_velocity(self, velocity: _Vec3f) -> None: ...
    @overload
    def add_velocity(self, velocity: _Vec3f, node: int) -> None: ...
    def set_wind_velocity(self, velocity: _Vec3f) -> None: ...
    ...
    def append_angular_joint(self, body: BulletBodyNode, axis: _Vec3f, erp: float = ..., cfm: float = ..., split: float = ..., control: BulletSoftBodyControl = ...) -> None: ...
    ...
    def get_closest_node_index(self, point: _Vec3f, local: bool) -> int:
        ...
        ...
    @staticmethod
    def make_rope(info: BulletSoftBodyWorldInfo, _from: _Vec3f, to: _Vec3f, res: int, fixeds: int) -> BulletSoftBodyNode:
        """Factory"""
        ...
    @staticmethod
    def make_patch(info: BulletSoftBodyWorldInfo, corner00: _Vec3f, corner10: _Vec3f, corner01: _Vec3f, corner11: _Vec3f, resx: int, resy: int, fixeds: int, gendiags: bool) -> BulletSoftBodyNode: ...
    @staticmethod
    def make_ellipsoid(info: BulletSoftBodyWorldInfo, center: _Vec3f, radius: _Vec3f, res: int) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
...
class BulletSoftBodyWorldInfo:
    ...
    def set_water_normal(self, normal: _Vec3f) -> None: ...
    def set_gravity(self, gravity: _Vec3f) -> None: ...
...
class BulletWheel:
    ...
    def set_chassis_connection_point_cs(self, pos: _Vec3f) -> None:
        """Sets the point where the wheel is connected to the chassis."""
        ...
    def set_wheel_direction_cs(self, dir: _Vec3f) -> None:
        """Sets the wheel's forward vector.  (Most likely orthogonal to the axle
        vector.)
        """
        ...
    def set_wheel_axle_cs(self, axle: _Vec3f) -> None:
        """Determines the wheel axle normal vector."""
        ...
    def set_world_transform(self, mat: _Mat4f) -> None: ...
...
class BulletWorld(TypedReferenceCount):
    ...
    def ray_test_closest(self, from_pos: _Vec3f, to_pos: _Vec3f, mask: BitMask_uint32_t_32 = ...) -> BulletClosestHitRayResult:
        """Raycast and other queries"""
        ...
    def ray_test_all(self, from_pos: _Vec3f, to_pos: _Vec3f, mask: BitMask_uint32_t_32 = ...) -> BulletAllHitsRayResult: ...
...
class BulletConvexPointCloudShape(BulletShape):
    ...
    @overload
    def __init__(self, geom: Geom, scale: _Vec3f = ...) -> None: ...
    @overload
...
class BulletCylinderShape(BulletShape):
    ...
    @overload
    def __init__(self, half_extents: _Vec3f, up: _BulletUpAxis = ...) -> None: ...
    @overload
    def __init__(self, radius: float, height: float, up: _BulletUpAxis = ...) -> None: ...
    def get_radius(self) -> float: ...
    def get_half_extents_without_margin(self) -> LVecBase3f: ...
...
class BulletTranslationalLimitMotor:
    ...
    def set_low_limit(self, limit: _Vec3f) -> None: ...
    def set_high_limit(self, limit: _Vec3f) -> None: ...
    def set_target_velocity(self, velocity: _Vec3f) -> None: ...
    def set_max_motor_force(self, force: _Vec3f) -> None: ...
    def set_damping(self, damping: float) -> None: ...
    def set_softness(self, softness: float) -> None: ...
    def set_restitution(self, restitution: float) -> None: ...
    def set_normal_cfm(self, cfm: _Vec3f) -> None: ...
    def set_stop_erp(self, erp: _Vec3f) -> None: ...
    def set_stop_cfm(self, cfm: _Vec3f) -> None: ...
...
class BulletHingeConstraint(BulletConstraint):
    ...
    def set_max_motor_impulse(self, max_impulse: float) -> None:
        ...
        ...
    @overload
    def set_motor_target(self, quat: _Vec4f, dt: float) -> None: ...
    @overload
...
class BulletSphericalConstraint(BulletConstraint):
    ...
    pivot_b: LPoint3f
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, pivot_a: _Vec3f) -> None: ...
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, node_b: BulletRigidBodyNode, pivot_a: _Vec3f, pivot_b: _Vec3f) -> None: ...
    def set_pivot_a(self, pivot_a: _Vec3f) -> None:
        """Pivots"""
        ...
...
class BulletTriangleMesh(TypedWritableReferenceCount):
    ...
    def __init__(self) -> None: ...
    def add_triangle(self, p0: _Vec3f, p1: _Vec3f, p2: _Vec3f, remove_duplicate_vertices: bool = ...) -> None:
