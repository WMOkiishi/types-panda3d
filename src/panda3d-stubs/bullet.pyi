...
class BulletRayHit:
    ...
    def __init__(self, param0: BulletRayHit = ..., /) -> None: ...
...
class BulletClosestHitRayResult:
    ...
    @property
    def triangle_index(self) -> int: ...
    def __init__(self, param0: BulletClosestHitRayResult, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class BulletClosestHitSweepResult:
    ...
    @property
    def hit_fraction(self) -> float: ...
    def __init__(self, param0: BulletClosestHitSweepResult, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class BulletDebugNode(PandaNode):
    ...
    normals: bool
    @overload
    def __init__(self, param0: BulletDebugNode, /) -> None: ...
    @overload
    def __init__(self, name: str = ...) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class BulletSoftBodyNodeElement:
    ...
    def __init__(self, param0: BulletSoftBodyNodeElement, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class BulletSoftBodyConfig:
    ...
    def __init__(self, param0: BulletSoftBodyConfig, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class BulletSoftBodyWorldInfo:
    ...
    gravity: LVector3
    def __init__(self, param0: BulletSoftBodyWorldInfo, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class BulletSoftBodyMaterial:
    ...
    def __init__(self, param0: BulletSoftBodyMaterial, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class BulletWheel:
    ...
    def __init__(self, param0: BulletWheel, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def set_suspension_stiffness(self, value: float) -> None:
...
class BulletWheelRaycastInfo:
    ...
    def __init__(self, param0: BulletWheelRaycastInfo, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class BulletPersistentManifold:
    ...
    def __init__(self, param0: BulletPersistentManifold, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def get_node0(self) -> PandaNode: ...
    def get_node1(self) -> PandaNode: ...
...
class BulletHelper:
    ...
    def __init__(self, param0: BulletHelper = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class BulletSoftBodyControl:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: BulletSoftBodyControl = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
