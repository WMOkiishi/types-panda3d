...
class BulletBodyNode(PandaNode):
    ...
    def set_anisotropic_friction(self, friction: Vec3f) -> None: ...
...
class BulletBoxShape(BulletShape):
    ...
    @overload
    def __init__(self, halfExtents: Vec3f) -> None: ...
...
class BulletCharacterControllerNode(BulletBaseCharacterControllerNode):
    ...
    def set_linear_movement(self, velocity: Vec3f, is_local: bool) -> None: ...
...
class BulletRigidBodyNode(BulletBodyNode):
    ...
    def set_inertia(self, inertia: Vec3f) -> None:
    ...
    def set_linear_velocity(self, velocity: Vec3f) -> None: ...
    def set_angular_velocity(self, velocity: Vec3f) -> None: ...
    ...
    def clear_forces(self) -> None:
        """Forces"""
    def apply_force(self, force: Vec3f, pos: Vec3f) -> None: ...
    def apply_central_force(self, force: Vec3f) -> None: ...
    def apply_impulse(self, impulse: Vec3f, pos: Vec3f) -> None: ...
    def apply_central_impulse(self, impulse: Vec3f) -> None: ...
    def apply_torque(self, torque: Vec3f) -> None: ...
    def apply_torque_impulse(self, torque: Vec3f) -> None: ...
    ...
    def set_gravity(self, gravity: Vec3f) -> None:
        """Gravity"""
    def get_gravity(self) -> LVector3: ...
    def get_linear_factor(self) -> LVector3:
        """Restrict movement"""
    def get_angular_factor(self) -> LVector3: ...
    def set_linear_factor(self, factor: Vec3f) -> None: ...
    def set_angular_factor(self, factor: Vec3f) -> None: ...
...
class BulletConeTwistConstraint(BulletConstraint):
    ...
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, node_b: BulletRigidBodyNode, frame_a: TransformState, frame_b: TransformState) -> None: ...
    @overload
    def set_limit(self, index: int, value: float) -> None: ...
    @overload
    def set_limit(self, swing1: float, swing2: float, twist: float, softness: float = ..., bias: float = ..., relaxation: float = ...) -> None: ...
    ...
    def set_motor_target(self, quat: Vec4f) -> None: ...
    def set_motor_target_in_constraint_space(self, quat: Vec4f) -> None: ...
...
class BulletManifoldPoint:
    ...
    def set_lateral_friction_dir1(self, dir: Vec3f) -> None: ...
    def set_lateral_friction_dir2(self, dir: Vec3f) -> None: ...
...
class BulletContactCallbackData(CallbackData):
    ...
    @property
    def index1(self) -> int: ...
    def __init__(self, mp: BulletManifoldPoint, node0: PandaNode, node1: PandaNode, id0: int, id1: int, index0: int, index1: int) -> None: ...
...
class BulletSoftBodyNode(BulletBodyNode):
    ...
    def add_force(self, force: Vec3f, node: int = ...) -> None: ...
    def set_velocity(self, velocity: Vec3f) -> None: ...
    def add_velocity(self, velocity: Vec3f, node: int = ...) -> None: ...
    def set_wind_velocity(self, velocity: Vec3f) -> None: ...
    ...
    def append_anchor(self, node: int, body: BulletRigidBodyNode, disable: bool = ...) -> None:
        """Anchors"""
    @overload
    def append_anchor(self, node: int, body: BulletRigidBodyNode, pivot: Vec3f, disable: bool = ...) -> None: ...
    @overload
    def append_linear_joint(self, body: BulletBodyNode, pos: Vec3f, erp: float = ..., cfm: float = ..., split: float = ...) -> None: ...
    @overload
    def append_linear_joint(self, body: BulletBodyNode, cluster: int, erp: float = ..., cfm: float = ..., split: float = ...) -> None: ...
    def append_angular_joint(self, body: BulletBodyNode, axis: Vec3f, erp: float = ..., cfm: float = ..., split: float = ..., control: BulletSoftBodyControl = ...) -> None: ...
    ...
    def get_closest_node_index(self, point: Vec3f, local: bool) -> int:
        ...
        """
    @staticmethod
    def make_rope(info: BulletSoftBodyWorldInfo, _from: Vec3f, to: Vec3f, res: int, fixeds: int) -> BulletSoftBodyNode:
        """Factory"""
    @staticmethod
    def make_patch(info: BulletSoftBodyWorldInfo, corner00: Vec3f, corner10: Vec3f, corner01: Vec3f, corner11: Vec3f, resx: int, resy: int, fixeds: int, gendiags: bool) -> BulletSoftBodyNode: ...
    @staticmethod
    def make_ellipsoid(info: BulletSoftBodyWorldInfo, center: Vec3f, radius: Vec3f, res: int) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
    def make_tri_mesh(info: BulletSoftBodyWorldInfo, geom: Geom, randomizeConstraints: bool = ...) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
    def make_tri_mesh(info: BulletSoftBodyWorldInfo, points: PTA_LVecBase3, indices: PTA_int, randomizeConstraints: bool = ...) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
    def make_tet_mesh(info: BulletSoftBodyWorldInfo, points: PTA_LVecBase3, indices: PTA_int, tetralinks: bool = ...) -> BulletSoftBodyNode: ...
    @overload
    @staticmethod
...
class BulletSoftBodyWorldInfo:
    ...
    def set_water_normal(self, normal: Vec3f) -> None: ...
    def set_gravity(self, gravity: Vec3f) -> None: ...
...
class BulletWheel:
    ...
    def set_chassis_connection_point_cs(self, pos: Vec3f) -> None:
        """Sets the point where the wheel is connected to the chassis."""
    def set_wheel_direction_cs(self, dir: Vec3f) -> None:
        """Sets the wheel's forward vector.  (Most likely orthogonal to the axle
        vector.)
        """
    def set_wheel_axle_cs(self, axle: Vec3f) -> None:
        """Determines the wheel axle normal vector."""
    def set_world_transform(self, mat: Mat4f) -> None: ...
...
class BulletWorld(TypedReferenceCount):
    ...
    def ray_test_closest(self, from_pos: Vec3f, to_pos: Vec3f, mask: CollideMask = ...) -> BulletClosestHitRayResult:
        """Raycast and other queries"""
    def ray_test_all(self, from_pos: Vec3f, to_pos: Vec3f, mask: CollideMask = ...) -> BulletAllHitsRayResult: ...
    def sweep_test_closest(self, shape: BulletShape, from_ts: TransformState, to_ts: TransformState, mask: CollideMask = ..., penetration: float = ...) -> BulletClosestHitSweepResult:
    ...
    def set_contact_added_callback(self, obj: CallbackObject) -> None:
        """Callbacks"""
    def clear_contact_added_callback(self) -> None: ...
    def set_tick_callback(self, obj: CallbackObject, is_pretick: bool = ...) -> None: ...
    def clear_tick_callback(self) -> None: ...
    def set_filter_callback(self, obj: CallbackObject) -> None: ...
...
class BulletConvexHullShape(BulletShape):
    ...
    def add_point(self, p: Vec3f) -> None: ...
...
class BulletConvexPointCloudShape(BulletShape):
    ...
    @overload
    def __init__(self, geom: Geom, scale: Vec3f = ...) -> None: ...
    @overload
    def __init__(self, points: PTA_LVecBase3, scale: Vec3f = ...) -> None: ...
...
class BulletCylinderShape(BulletShape):
    ...
    @overload
    def __init__(self, half_extents: Vec3f, up: _BulletUpAxis = ...) -> None: ...
    @overload
    def __init__(self, radius: float, height: float, up: _BulletUpAxis = ...) -> None: ...
    def get_radius(self) -> float: ...
    def get_half_extents_without_margin(self) -> LVecBase3: ...
...
class BulletTranslationalLimitMotor:
    ...
    def set_low_limit(self, limit: Vec3f) -> None: ...
    def set_high_limit(self, limit: Vec3f) -> None: ...
    def set_target_velocity(self, velocity: Vec3f) -> None: ...
    def set_max_motor_force(self, force: Vec3f) -> None: ...
    def set_damping(self, damping: float) -> None: ...
    def set_softness(self, softness: float) -> None: ...
    def set_restitution(self, restitution: float) -> None: ...
    def set_normal_cfm(self, cfm: Vec3f) -> None: ...
    def set_stop_erp(self, erp: Vec3f) -> None: ...
    def set_stop_cfm(self, cfm: Vec3f) -> None: ...
...
class BulletGenericConstraint(BulletConstraint):
    ...
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, node_b: BulletRigidBodyNode, frame_a: TransformState, frame_b: TransformState, use_frame_a: bool) -> None: ...
...
class BulletHingeConstraint(BulletConstraint):
    ...
    def __init__(self, node_a: BulletRigidBodyNode, ts_a: TransformState, use_frame_a: bool = ...) -> None:
        ...
        """
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, pivot_a: Vec3f, axis_a: Vec3f, use_frame_a: bool = ...) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, node_b: BulletRigidBodyNode, pivot_a: Vec3f, pivot_b: Vec3f, axis_a: Vec3f, axis_b: Vec3f, use_frame_a: bool = ...) -> None: ...
    ...
    def set_max_motor_impulse(self, max_impulse: float) -> None:
        ...
        """
    @overload
    def set_motor_target(self, quat: Vec4f, dt: float) -> None: ...
    @overload
...
class BulletPlaneShape(BulletShape):
    ...
    @overload
    def __init__(self, normal: Vec3f, constant: float) -> None: ...
...
class BulletSphericalConstraint(BulletConstraint):
    ...
    pivot_b: LPoint3
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, pivot_a: Vec3f) -> None: ...
    @overload
    def __init__(self, node_a: BulletRigidBodyNode, node_b: BulletRigidBodyNode, pivot_a: Vec3f, pivot_b: Vec3f) -> None: ...
    def set_pivot_a(self, pivot_a: Vec3f) -> None:
        """Pivots"""
    def set_pivot_b(self, pivot_b: Vec3f) -> None: ...
...
class BulletTriangleMeshShape(BulletShape):
    ...
    def refit_tree(self, aabb_min: Vec3f, aabb_max: Vec3f) -> None: ...
    def is_static(self) -> bool: ...
