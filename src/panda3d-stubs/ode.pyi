...
from typing import Any, ClassVar, Final, overload, type_check_only
...
class OdeJointFeedback:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: OdeJointFeedback = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class OdeJoint(TypedObject):
    ...
    def set_feedback(self, param0_or_flag: OdeJointFeedback | bool = ..., /) -> None: ...
...
class OdeSpace(TypedObject):
    ...
    def query(self, geom_or_space: OdeGeom | OdeSpace, /) -> int: ...
    ...
    def disable(self) -> None: ...
    def is_enabled(self) -> int: ...
    def set_auto_collide_world(self, param0: OdeWorld, /) -> None: ...
    def set_auto_collide_joint_group(self, param0: OdeJointGroup, /) -> None: ...
    def add(self, geom_or_space: OdeGeom | OdeSpace, /) -> None: ...
    def remove(self, geom_or_space: OdeGeom | OdeSpace, /) -> None: ...
    def clean(self) -> None: ...
    ...
    def get_surface_type(self, geom_or_o1: OdeGeom | dxGeom, /) -> int: ...
    def get_collide_id(self, geom_or_o1: OdeGeom | dxGeom, /) -> int: ...
...
class OdeCollisionEntry(TypedReferenceCount):
    ...
    def __init__(self, param0: OdeCollisionEntry, /) -> None: ...
    def __bool__(self) -> bool: ...
...
class OdeJointCollection:
    ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[OdeJoint]: ...
...
class OdeUtil:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: OdeUtil = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
