...
class SparkleParticleRenderer(BaseParticleRenderer):
    ...
    def set_life_scale(self, param0: _SparkleParticleRenderer_SparkleParticleLifeScale, /) -> None: ...
...
class SpriteAnim(ReferenceCount):
    ...
    STFromNode: Final = 1
    def __init__(self, param0: SpriteAnim, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @overload
...
class ParticleSystemManager:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: ParticleSystemManager, /) -> None: ...
    @overload
