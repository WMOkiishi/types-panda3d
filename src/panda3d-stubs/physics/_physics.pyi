...
class PhysicsObject(TypedReferenceCount):
    ...
    def get_active(self) -> bool:
        """Process Flag Query"""
    def set_mass(self, param0: float, /) -> None:
...
class PhysicalNode(PandaNode):
    ...
    def insert_physical(self, index: int, physical: Physical) -> None:
        """insert operation"""
    def remove_physical(self, physical_or_index: Physical | int, /) -> None:
        """remove operation"""
...
class BaseIntegrator(ReferenceCount):
    ...
    def __init__(self, param0: BaseIntegrator, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def output(self, out: ostream, /) -> None:
        """Write a string representation of this instance to <out>."""
...
class ForceNode(PandaNode):
    ...
    def insert_force(self, index: int, force: BaseForce) -> None:
        """insert operation"""
    def remove_force(self, force_or_index: BaseForce | int, /) -> None:
        """remove operation"""
...
class PhysicsManager:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: PhysicsManager = ..., /) -> None:
