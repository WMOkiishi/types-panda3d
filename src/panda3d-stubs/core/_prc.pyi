...
class ConfigFlags:
    ...
    def __init__(self, param0: ConfigFlags = ..., /) -> None: ...
...
class Notify:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: Notify = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class ConfigVariable(ConfigVariableBase):
    ...
    @overload
    def __init__(self, param0: ConfigVariable, /) -> None: ...
    @overload
...
class ConfigVariableBool(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableBool, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
...
class ConfigVariableDouble(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableDouble, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
...
class ConfigVariableFilename(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableFilename, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
...
class ConfigVariableInt(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableInt, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
...
class ConfigVariableInt64(ConfigVariable):
    ...
    def default_value(self) -> int: ...
    @overload
    def __init__(self, param0: ConfigVariableInt64, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
    def __init__(self, name: str, default_value: int | str, description: str = ..., flags: int = ...) -> None: ...
...
class ConfigVariableList(ConfigVariableBase):
    ...
    @overload
    def __init__(self, param0: ConfigVariableList, /) -> None: ...
    @overload
...
class ConfigVariableSearchPath(ConfigVariableBase):
    ...
    @overload
    def __init__(self, name: str, default_value: SearchPathLike | str, description: str, flags: int = ...) -> None: ...
    @overload
    def __init__(self, name: str, description: str = ..., flags: int = ...) -> None: ...
...
class ConfigVariableString(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableString, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    @overload
...
class NotifyCategory(ConfigFlags):
    ...
    def __init__(self, param0: NotifyCategory, /) -> None: ...
    def upcast_to_ConfigFlags(self) -> ConfigFlags: ...
