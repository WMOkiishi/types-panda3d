...
class AnimGroup(TypedWritableReferenceCount, Namable):
    ...
    def __init__(self, parent: AnimGroup, name: str) -> None:
        ...
        """
    @overload
    def __init__(self, param0: AnimGroup, /) -> None: ...
...
class AnimBundle(AnimGroup):
    ...
    @overload
    def __init__(self, param0: AnimBundle, /) -> None: ...
    @overload
...
class AnimControlCollection:
    ...
    def __init__(self, param0: AnimControlCollection = ..., /) -> None:
...
class PartBundleHandle(ReferenceCount):
    ...
    @overload
    def __init__(self, param0: PartBundleHandle, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
