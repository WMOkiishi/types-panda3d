...
class ParametricCurveCollection(ReferenceCount):
    ...
    def __init__(self, param0: ParametricCurveCollection = ..., /) -> None: ...
...
class CurveFitter:
    ...
    def __init__(self, param0: CurveFitter = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def reset(self) -> None:
...
class NurbsCurveResult(ReferenceCount):
    ...
    def __init__(self, param0: NurbsCurveResult, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class NurbsCurveEvaluator(ReferenceCount):
    ...
    def __init__(self, param0: NurbsCurveEvaluator = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def set_order(self, order: int) -> None:
...
class NurbsSurfaceResult(ReferenceCount):
    ...
    def __init__(self, param0: NurbsSurfaceResult, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class NurbsSurfaceEvaluator(ReferenceCount):
    ...
    def __init__(self, param0: NurbsSurfaceEvaluator = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
