...
from panda3d.core import LVecBase4f, Namable, PNMImage
...
class PNMTextGlyph:
    ...
    def get_advance(self) -> int:
        ...
        """
        ...
    def place(self, dest_image: PNMImage, xp: int, yp: int, fg: Vec4f, interior: Vec4f = ...) -> None:
...
class PNMTextMaker(FreetypeFont):
    ...
    def get_fg(self) -> LVecBase4f:
        ...
        """
        ...
    def set_interior(self, interior: Vec4f) -> None:
