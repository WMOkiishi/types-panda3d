...
class ButtonThrower(DataNode):
    ...
    @overload
    def __init__(self, param0: ButtonThrower, /) -> None: ...
    @overload
...
class MouseInterfaceNode(DataNode):
    ...
    def __init__(self, param0: MouseInterfaceNode, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class MouseSubregion(MouseInterfaceNode):
    ...
    @overload
    def __init__(self, param0: MouseSubregion, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
...
class MouseWatcherRegion(TypedWritableReferenceCount, Namable):
    ...
    def area(self) -> float: ...
    @overload
    def __init__(self, param0: MouseWatcherRegion, /) -> None: ...
    @overload
...
class Trackball(MouseInterfaceNode):
    ...
    CMRoll: Final = 4
    @overload
    def __init__(self, param0: Trackball, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    def reset(self) -> None:
...
class Transform2SG(DataNode):
    ...
    @overload
    def __init__(self, param0: Transform2SG, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
