...
class URLSpec:
    ...
    def ssl(self) -> bool: ...
    @overload
    def __init__(self, param0: URL = ..., /) -> None: ...
    @overload
...
class HTTPEnum:
    ...
    MConnect: Final = 7
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: HTTPEnum = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class HTTPChannel(TypedReferenceCount):
    ...
    def __init__(self, param0: HTTPChannel, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class Decompressor:
    ...
    def __init__(self, param0: Decompressor = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    ...
    def run(self) -> int:
        ...
        """
    def decompress(self, source_file_or_source_and_dest_file: Ramfile | StrOrBytesPath, /) -> bool:
...
class DownloadDb:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: DownloadDb = ..., /) -> None:
...
class Patcher:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: Patcher = ..., /) -> None: ...
    @overload
