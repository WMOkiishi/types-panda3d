...
class MathNumbers:
    ...
    def __init__(self, param0: MathNumbers = ..., /) -> None: ...
...
class LVecBase2f:
    ...
    y: float
    @overload
    def __init__(self, param0: Vec2Like = ..., /) -> None: ...
    @overload
    ...
    def assign(self, copy_or_fill_value: Vec2Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase2f:
...
class LVecBase2d:
    ...
    y: float
    @overload
    def __init__(self, param0: DoubleVec2Like = ..., /) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    def __init__(self, x: float, y: float) -> None: ...
    ...
    @type_check_only
    def __iter__(self) -> Iterator[float]: ...
    def assign(self, copy_or_fill_value: DoubleVec2Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase2d:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase2i:
    ...
    y: int
    @overload
    def __init__(self, param0: IntVec2Like = ..., /) -> None: ...
    @overload
    ...
    def assign(self, copy_or_fill_value: IntVec2Like | int, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase2i:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase3f:
    ...
    @overload
    def __init__(self, param0: Vec3Like = ..., /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[float]: ...
    def assign(self, copy_or_fill_value: Vec3Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase3f:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase3d:
    ...
    @overload
    def __init__(self, param0: DoubleVec3Like = ..., /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[float]: ...
    def assign(self, copy_or_fill_value: DoubleVec3Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase3d:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase3i:
    ...
    @overload
    def __init__(self, param0: IntVec3Like = ..., /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[int]: ...
    def assign(self, copy_or_fill_value: IntVec3Like | int, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase3i:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase4f:
    ...
    @overload
    def __init__(self, param0: Vec4Like, /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[float]: ...
    def assign(self, copy_or_fill_value: Vec4Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase4f:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase4d:
    ...
    @overload
    def __init__(self, param0: DoubleVec4Like, /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[float]: ...
    def assign(self, copy_or_fill_value: DoubleVec4Like | float, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase4d:
        """Returns a zero-length vector."""
    @staticmethod
...
class LVecBase4i:
    ...
    @overload
    def __init__(self, param0: IntVec4Like, /) -> None: ...
    @overload
    ...
    @type_check_only
    def __iter__(self) -> Iterator[int]: ...
    def assign(self, copy_or_fill_value: IntVec4Like | int, /) -> Self: ...
    @staticmethod
    def zero() -> LVecBase4i:
        """Returns a zero-length vector."""
    @staticmethod
...
class LMatrix3f:
    ...
    class Row:
        ...
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix3f.Row, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __setitem__(self, i: int, assign_val: float, /) -> None: ...
        def __len__(self) -> int:
    ...
    class CRow:
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix3f.CRow, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __len__(self) -> int:
            """Returns 3: the number of columns of a LMatrix3."""
        def __copy__(self) -> Self: ...
    ...
    @overload
    def __init__(self, param0: Vec3Like, param1: Vec3Like, param2: Vec3Like, /) -> None:
    ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    def __mul__(self, other_or_scalar: LMatrix3f | float, /) -> LMatrix3f: ...
    ...
    def __imul__(self, other_or_scalar: LMatrix3f | float, /) -> Self:
        """Performs a memberwise scale."""
    def __itruediv__(self, scalar: float, /) -> Self:
        """Performs a memberwise scale."""
    def __rmul__(self, scalar: float, /) -> LMatrix3f: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LMatrix3f.CRow | LMatrix3f.Row]: ...
    def assign(self, other_or_fill_value: LMatrix3f | float, /) -> Self: ...
    def fill(self, fill_value: float, /) -> None:
...
class LMatrix4f:
    ...
    class Row:
        ...
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix4f.Row, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __setitem__(self, i: int, assign_val: float, /) -> None: ...
        def __len__(self) -> int:
    ...
    class CRow:
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix4f.CRow, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __len__(self) -> int:
            """Returns 4: the number of columns of a LMatrix4."""
        def __copy__(self) -> Self: ...
    ...
    @overload
    def __init__(self, param0: Vec4Like, param1: Vec4Like, param2: Vec4Like, param3: Vec4Like, /) -> None:
    ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    def __mul__(self, other_or_scalar: Mat4Like | float, /) -> LMatrix4f: ...
    def __truediv__(self, scalar: float, /) -> LMatrix4f: ...
    def __iadd__(self, other: Mat4Like, /) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self, other: Mat4Like, /) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    def __imul__(self, other_or_scalar: Mat4Like | float, /) -> Self: ...
    def __itruediv__(self, scalar: float, /) -> Self: ...
    def __rmul__(self, scalar: float, /) -> LMatrix4f: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LMatrix4f.CRow | LMatrix4f.Row]: ...
    def assign(self, other_or_fill_value: Mat4Like | float, /) -> Self: ...
    def fill(self, fill_value: float, /) -> None:
        """Sets each element of the matrix to the indicated fill_value.  This is of
        questionable value, but is sometimes useful when initializing to zero.
        """
...
class LMatrix3d:
    ...
    class Row:
        ...
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix3d.Row, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __setitem__(self, i: int, assign_val: float, /) -> None: ...
        def __len__(self) -> int:
            """Returns 3: the number of columns of a LMatrix3."""
    ...
    class CRow:
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix3d.CRow, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __len__(self) -> int:
            """Returns 3: the number of columns of a LMatrix3."""
        def __copy__(self) -> Self: ...
    ...
    @overload
    def __init__(self, param0: DoubleVec3Like, param1: DoubleVec3Like, param2: DoubleVec3Like, /) -> None:
        """Constructs the matrix from three individual rows."""
    @overload
    def __init__(
        self,
    ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    def __mul__(self, other_or_scalar: LMatrix3d | float, /) -> LMatrix3d: ...
    def __truediv__(self, scalar: float, /) -> LMatrix3d: ...
    def __iadd__(self, other: LMatrix3d, /) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self, other: LMatrix3d, /) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    def __imul__(self, other_or_scalar: LMatrix3d | float, /) -> Self:
        """Performs a memberwise scale."""
    def __itruediv__(self, scalar: float, /) -> Self:
        """Performs a memberwise scale."""
    def __rmul__(self, scalar: float, /) -> LMatrix3d: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LMatrix3d.CRow | LMatrix3d.Row]: ...
    def assign(self, other_or_fill_value: LMatrix3d | float, /) -> Self: ...
    def fill(self, fill_value: float, /) -> None:
        """Sets each element of the matrix to the indicated fill_value.  This is of
        questionable value, but is sometimes useful when initializing to zero.
        """
...
class LMatrix4d:
    ...
    class Row:
        ...
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix4d.Row, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __setitem__(self, i: int, assign_val: float, /) -> None: ...
        def __len__(self) -> int:
            """Returns 4: the number of columns of a LMatrix4."""
    ...
    class CRow:
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: LMatrix4d.CRow, /) -> None: ...
        def __getitem__(self, i: int, /) -> float: ...
        def __len__(self) -> int:
            """Returns 4: the number of columns of a LMatrix4."""
        def __copy__(self) -> Self: ...
    ...
    @overload
    def __init__(self, param0: DoubleVec4Like, param1: DoubleVec4Like, param2: DoubleVec4Like, param3: DoubleVec4Like, /) -> None:
        """Constructs the matrix from four individual rows."""
    @overload
    def __init__(
        self,
    ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    def __mul__(self, other_or_scalar: DoubleMat4Like | float, /) -> LMatrix4d: ...
    ...
    def __isub__(self, other: DoubleMat4Like, /) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    def __imul__(self, other_or_scalar: DoubleMat4Like | float, /) -> Self: ...
    def __itruediv__(self, scalar: float, /) -> Self: ...
    def __rmul__(self, scalar: float, /) -> LMatrix4d: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LMatrix4d.CRow | LMatrix4d.Row]: ...
    def assign(self, other_or_fill_value: DoubleMat4Like | float, /) -> Self: ...
    def fill(self, fill_value: float, /) -> None:
        """Sets each element of the matrix to the indicated fill_value.  This is of
        questionable value, but is sometimes useful when initializing to zero.
        """
...
class LQuaternionf(LVecBase4f):
    ...
    def __mul__(self, param0: LMatrix3f, /) -> LMatrix3f: ...
    @overload
    def __mul__(self, param0: LMatrix4f, /) -> LMatrix4f: ...
    @overload
...
class LQuaterniond(LVecBase4d):
    ...
    @overload  # type: ignore[override]
    def __mul__(self, param0: LMatrix3d, /) -> LMatrix3d: ...
    @overload
    def __mul__(self, param0: LMatrix4d, /) -> LMatrix4d: ...
    @overload
...
class ConfigVariableColor(ConfigVariable):
    ...
    @overload
    def __init__(self, param0: ConfigVariableColor, /) -> None: ...
    @overload
...
@overload
def transpose(a: LMatrix4d, /) -> LMatrix4d: ...
@overload
def transpose(a: LMatrix4f, /) -> LMatrix4f: ...
@overload
def invert(a: LMatrix3d, /) -> LMatrix3d: ...
@overload
def invert(a: LMatrix3f, /) -> LMatrix3f: ...
@overload
def invert(a: LMatrix4d, /) -> LMatrix4d: ...
@overload
def invert(a: LMatrix4f, /) -> LMatrix4f: ...
@overload
...
UnalignedLVecBase4f = LVecBase4f
UnalignedLVecBase4d = LVecBase4d
UnalignedLVecBase4i = LVecBase4i
UnalignedLMatrix4f = LMatrix4f
UnalignedLMatrix4d = LMatrix4d
Mat4F = LMatrix4f
Mat3F = LMatrix3f
VBase4F = LVecBase4f
Vec4F = LVector4f
