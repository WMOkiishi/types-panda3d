...
class LVecBase2f:
    ...
    def __iadd__(self: Self, other: Vec2Like) -> Self: ...
    def __isub__(self: Self, other: Vec2Like) -> Self: ...
    ...
    @overload
    def assign(self, copy: Vec2Like) -> LVecBase2f: ...
    @overload
    ...
    def normalized(self: Self) -> Self:
        ...
        """
    def project(self: Self, onto: Vec2Like) -> Self:
...
class LVecBase2d:
    ...
    def __mul__(self: Self, scalar: float) -> Self: ...
    def __truediv__(self: Self, scalar: float) -> Self: ...
    def __iadd__(self: Self, other: DoubleVec2Like) -> Self: ...
    def __isub__(self: Self, other: DoubleVec2Like) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    ...
    def __iter__(self) -> Iterator[float]: ...  # Doesn't actually exist
    @overload
    def assign(self, copy: DoubleVec2Like) -> LVecBase2d: ...
    @overload
    ...
    def normalized(self: Self) -> Self:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self: Self, onto: DoubleVec2Like) -> Self:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVecBase2i:
    ...
    def __iadd__(self: Self, other: IntVec2Like) -> Self: ...
    def __isub__(self: Self, other: IntVec2Like) -> Self: ...
    ...
    @overload
    def assign(self, copy: IntVec2Like) -> LVecBase2i: ...
    @overload
...
class LVecBase3i:
    ...
    def __mul__(self: Self, scalar: int) -> Self: ...
    def __iadd__(self: Self, other: IntVec3Like) -> Self: ...
    def __isub__(self: Self, other: IntVec3Like) -> Self: ...
    def __imul__(self: Self, scalar: int) -> Self: ...
    def __floordiv__(self: Self, scalar: int) -> Self: ...
    def __ifloordiv__(self: Self, scalar: int) -> Self: ...
    def __pow__(self: Self, exponent: int) -> Self: ...
    ...
    def __iter__(self) -> Iterator[int]: ...  # Doesn't actually exist
    @overload
    def assign(self, copy: IntVec3Like) -> LVecBase3i: ...
    @overload
