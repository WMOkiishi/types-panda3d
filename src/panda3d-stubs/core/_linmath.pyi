...
class LVecBase3f:
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: Vec3Like) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...  # Doesn't actually exist
    @overload
    ...
    def normalized(self) -> LVecBase3f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec3Like) -> LVecBase3f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVecBase3d:
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: DoubleVec3Like) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...  # Doesn't actually exist
    @overload
    ...
    def normalized(self) -> LVecBase3d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec3Like) -> LVecBase3d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVector3f(LVecBase3f):
    ...
    def normalized(self) -> LVector3f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec3Like) -> LVector3f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVector3d(LVecBase3d):
    ...
    def normalized(self) -> LVector3d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec3Like) -> LVector3d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LPoint3f(LVecBase3f):
    ...
    def normalized(self) -> LPoint3f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec3Like) -> LPoint3f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    @staticmethod
...
class LPoint3d(LVecBase3d):
    ...
    def normalized(self) -> LPoint3d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec3Like) -> LPoint3d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    @staticmethod
...
class LVecBase4f:
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: Vec4Like) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...  # Doesn't actually exist
    @overload
    ...
    def normalized(self) -> LVecBase4f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec4Like) -> LVecBase4f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVecBase4d:
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: DoubleVec4Like) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...  # Doesn't actually exist
    @overload
    ...
    def normalized(self) -> LVecBase4d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec4Like) -> LVecBase4d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
...
class LVecBase4i:
    ...
    def __iadd__(self: Self, other: IntVec4Like) -> Self: ...
    def __isub__(self: Self, other: IntVec4Like) -> Self: ...
    def __imul__(self: Self, scalar: int) -> Self: ...
    def __floordiv__(self: Self, scalar: int) -> Self: ...
    def __ifloordiv__(self: Self, scalar: int) -> Self: ...
    def __pow__(self: Self, exponent: int) -> Self: ...
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: IntVec4Like) -> bool: ...
    def __iter__(self) -> Iterator[int]: ...  # Doesn't actually exist
    @overload
    def assign(self, copy: IntVec4Like) -> LVecBase4i: ...
    @overload
...
class LVector4f(LVecBase4f):
    ...
    def normalized(self) -> LVector4f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec4Like) -> LVector4f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    unitX = unit_x
...
class LVector4d(LVecBase4d):
    ...
    def normalized(self) -> LVector4d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec4Like) -> LVector4d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    unitX = unit_x
...
class LPoint4f(LVecBase4f):
    ...
    def normalized(self) -> LPoint4f:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: Vec4Like) -> LPoint4f:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    unitX = unit_x
...
class LPoint4d(LVecBase4d):
    ...
    def normalized(self) -> LPoint4d:
        ...
        vector was a zero-length vector, a zero length vector will be returned.
        """
    def project(self, onto: DoubleVec4Like) -> LPoint4d:
        """Returns a new vector representing the projection of this vector onto
        another one.  The resulting vector will be a scalar multiple of onto.
        """
    unitX = unit_x
...
class LMatrix4f:
    ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __le__(self, other: Mat4Like) -> bool: ...
...
class UnalignedLMatrix4f:
    ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    def assign(self, copy: Mat4Like) -> UnalignedLMatrix4f: ...
    def set(
        self,
        e00: float,
        e01: float,
...
class LMatrix4d:
    ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __le__(self, other: DoubleMat4Like) -> bool: ...
...
class UnalignedLMatrix4d:
    ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    def assign(self, copy: DoubleMat4Like) -> UnalignedLMatrix4d: ...
    def set(
        self,
        e00: float,
        e01: float,
...
class ConfigVariableColor(ConfigVariable):
    ...
    def assign(self, value: Vec4Like) -> ConfigVariableColor: ...
...
@overload
def __mul__(v: DoubleVec3Like, m: DoubleMat4Like) -> LPoint3d | LVector3d: ...
@overload
def __mul__(v: Vec3Like, m: Mat4Like) -> LPoint3f | LVector3f: ...
@overload
...
@overload
def __imul__(v: DoubleVec3Like | LPoint3d | LVecBase2d | LVector3d, m: LMatrix3d) -> None: ...
@overload
def __imul__(v: LPoint3f | LVecBase2f | LVector3f | Vec3Like, m: LMatrix3f) -> None: ...
@overload
