...
class LQuaternionf(LVecBase4f):
    ...
    @overload
    def __mul__(self, param0: Vec4Like, /) -> LQuaternionf: ...
    @overload
...
class LQuaterniond(LVecBase4d):
    ...
    @overload
    def __mul__(self, param0: DoubleVec4Like, /) -> LQuaterniond: ...
    @overload
...
class LRotationf(LQuaternionf):
    ...
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    @overload  # type: ignore[override]
    def __mul__(self, other: LMatrix3f | LMatrix4f | Vec4Like) -> LRotationf: ...
    @overload
...
class LRotationd(LQuaterniond):
    ...
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    @overload  # type: ignore[override]
    def __mul__(self, other: DoubleVec4Like | LMatrix3d | LMatrix4d) -> LRotationd: ...
    @overload
