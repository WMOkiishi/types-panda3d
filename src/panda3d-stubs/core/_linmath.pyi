...
class LVecBase2f:
    ...
    def __iadd__(self: Self, other: LVecBase2f) -> Self: ...
    def __isub__(self: Self, other: LVecBase2f) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    def __pow__(self: Self, exponent: float) -> Self: ...
    def __ipow__(self: Self, exponent: float) -> Self: ...
    def __round__(self: Self) -> Self: ...
...
class LVecBase2d:
    ...
    def __iadd__(self: Self, other: LVecBase2d) -> Self: ...
    def __isub__(self: Self, other: LVecBase2d) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
...
class LVecBase2i:
    ...
    def __iadd__(self: Self, other: LVecBase2i) -> Self: ...
    def __isub__(self: Self, other: LVecBase2i) -> Self: ...
    def __imul__(self: Self, scalar: int) -> Self: ...
    def __floordiv__(self: Self, scalar: int) -> Self: ...
    def __ifloordiv__(self: Self, scalar: int) -> Self: ...
    def __pow__(self: Self, exponent: int) -> Self: ...
    def __ipow__(self: Self, exponent: int) -> Self: ...
    def __round__(self: Self) -> Self: ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
...
class LVecBase3f:
    ...
    @overload
    def __init__(self, __param0: Vec3f = ...) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    ...
    def __add__(self, other: Vec3f) -> LVecBase3f: ...
    def __sub__(self, other: Vec3f) -> LVecBase3f: ...
    def __mul__(self, scalar: float) -> LVecBase3f: ...
    def __truediv__(self, scalar: float) -> LVecBase3f: ...
    def __iadd__(self: Self, other: Vec3f) -> Self: ...
    def __isub__(self: Self, other: Vec3f) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: Vec3f) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...
    @overload
    def assign(self, copy: Vec3f) -> LVecBase3f: ...
    @overload
    ...
    def cross_into(self, other: Vec3f) -> None: ...
    def almost_equal(self, other: Vec3f, threshold: float = ...) -> bool:
        """`(self, other: LVecBase3f)`:
        Returns true if two vectors are memberwise equal within a default tolerance
        based on the numeric type.
...
class LVecBase3d:
    ...
    @overload
    def __init__(self, __param0: Vec3d = ...) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    ...
    def __setitem__(self, i: int, assign_val: float) -> None: ...
    def __len__(self) -> Literal[3]: ...
    def __lt__(self, other: Vec3d) -> bool: ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    def __neg__(self) -> LVecBase3d: ...
    def __add__(self, other: Vec3d) -> LVecBase3d: ...
    def __sub__(self, other: Vec3d) -> LVecBase3d: ...
    def __mul__(self, scalar: float) -> LVecBase3d: ...
    def __truediv__(self, scalar: float) -> LVecBase3d: ...
    def __iadd__(self: Self, other: Vec3d) -> Self: ...
    def __isub__(self: Self, other: Vec3d) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: Vec3d) -> bool: ...
    def __iter__(self) -> Iterator[float]: ...
    @overload
    def assign(self, copy: Vec3d) -> LVecBase3d: ...
    @overload
    ...
    def cross_into(self, other: Vec3d) -> None: ...
    def almost_equal(self, other: Vec3d, threshold: float = ...) -> bool:
        """`(self, other: LVecBase3d)`:
        Returns true if two vectors are memberwise equal within a default tolerance
        based on the numeric type.
...
class LVecBase3i:
    ...
    def __iadd__(self: Self, other: LVecBase3i) -> Self: ...
    def __isub__(self: Self, other: LVecBase3i) -> Self: ...
    def __imul__(self: Self, scalar: int) -> Self: ...
    def __floordiv__(self: Self, scalar: int) -> Self: ...
    def __ifloordiv__(self: Self, scalar: int) -> Self: ...
    def __pow__(self: Self, exponent: int) -> Self: ...
...
class LVector3f(LVecBase3f):
    ...
    @overload
    def __init__(self, copy: Vec3f = ...) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    def __init__(self, copy: LVecBase2f, z: float) -> None: ...
...
class LVector3d(LVecBase3d):
    ...
    @overload
    def __init__(self, copy: Vec3d = ...) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    def __init__(self, copy: LVecBase2d, z: float) -> None: ...
...
class LVecBase4f:
    ...
    @overload
    def __init__(self, vector: Vec3f) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    def __init__(self, copy: Vec3f, w: float) -> None: ...
    @overload
    ...
    def __add__(self, other: Vec4f) -> LVecBase4f: ...
    def __sub__(self, other: Vec4f) -> LVecBase4f: ...
    def __mul__(self, scalar: float) -> LVecBase4f: ...
    def __truediv__(self, scalar: float) -> LVecBase4f: ...
    def __iadd__(self: Self, other: Vec4f) -> Self: ...
    def __isub__(self: Self, other: Vec4f) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    ...
    def __iter__(self) -> Iterator[float]: ...
    @overload
    def assign(self, copy: Vec4f) -> LVecBase4f: ...
    @overload
...
class LVecBase4d:
    ...
    @overload
    def __init__(self, vector: Vec3d) -> None: ...
    @overload
    def __init__(self, fill_value: float) -> None: ...
    @overload
    def __init__(self, copy: Vec3d, w: float) -> None: ...
    @overload
    def __init__(self, x: float, y: float, z: float, w: float) -> None: ...
    def __getitem__(self, i: int) -> float: ...
    def __setitem__(self, i: int, assign_val: float) -> None: ...
    ...
    def __add__(self, other: Vec4d) -> LVecBase4d: ...
    def __sub__(self, other: Vec4d) -> LVecBase4d: ...
    def __mul__(self, scalar: float) -> LVecBase4d: ...
    def __truediv__(self, scalar: float) -> LVecBase4d: ...
    def __iadd__(self: Self, other: Vec4d) -> Self: ...
    def __isub__(self: Self, other: Vec4d) -> Self: ...
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __floordiv__(self: Self, scalar: float) -> Self: ...
    def __ifloordiv__(self: Self, scalar: float) -> Self: ...
    ...
    def __iter__(self) -> Iterator[float]: ...
    @overload
    def assign(self, copy: Vec4d) -> LVecBase4d: ...
    @overload
...
class LVecBase4i:
    ...
    def __setitem__(self, i: int, assign_val: int) -> None: ...
    def __len__(self) -> Literal[4]: ...
    def __lt__(self, other: Vec4i) -> bool: ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    def __neg__(self) -> LVecBase4i: ...
    def __add__(self, other: Vec4i) -> LVecBase4i: ...
    def __sub__(self, other: Vec4i) -> LVecBase4i: ...
    def __mul__(self, scalar: int) -> LVecBase4i: ...
    def __iadd__(self: Self, other: Vec4i) -> Self: ...
    def __isub__(self: Self, other: Vec4i) -> Self: ...
    def __imul__(self: Self, scalar: int) -> Self: ...
    def __floordiv__(self: Self, scalar: int) -> Self: ...
    def __ifloordiv__(self: Self, scalar: int) -> Self: ...
    def __pow__(self: Self, exponent: int) -> Self: ...
    ...
    def __floor__(self: Self) -> Self: ...
    def __ceil__(self: Self) -> Self: ...
    def __le__(self, other: Vec4i) -> bool: ...
    def __iter__(self) -> Iterator[int]: ...
    @overload
    def assign(self, copy: Vec4i) -> LVecBase4i: ...
    @overload
    ...
    def almost_equal(self, other: Vec4i, threshold: int = ...) -> bool:
...
class LMatrix3f:
    ...
    def __iadd__(self: Self, other: LMatrix3f) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self: Self, other: LMatrix3f) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    @overload
    def __imul__(self: Self, other: LMatrix3f) -> Self:
...
class LMatrix4f:
    ...
    @overload
    def __init__(self, upper3: LMatrix3f, trans: Vec3f) -> None: ...
    @overload
    ...
    def __ne__(self, __other: object) -> bool: ...
    @overload
    def __mul__(self, other: Mat4f) -> LMatrix4f: ...
    @overload
    def __mul__(self, scalar: float) -> LMatrix4f: ...
    def __truediv__(self, scalar: float) -> LMatrix4f: ...
    def __iadd__(self: Self, other: Mat4f) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self: Self, other: Mat4f) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    @overload
    def __imul__(self: Self, other: Mat4f) -> Self: ...
    @overload
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __le__(self, other: Mat4f) -> bool: ...
    @overload
    def assign(self, other: Mat4f) -> LMatrix4f: ...
    @overload
    ...
    def transpose_in_place(self) -> None: ...
    def invert_from(self, other: Mat4f) -> bool:
        """Computes the inverse of the other matrix, and stores the result in this
        matrix.  This is a fully general operation and makes no assumptions about
        the type of transform represented by the matrix.
    ...
    @staticmethod
    def rotate_mat(angle: float, axis: Vec3f, cs: _CoordinateSystem = ...) -> LMatrix4f:
        """Returns a matrix that rotates by the given angle in degrees
        counterclockwise about the indicated vector.
        """
    @staticmethod
    ...
    @overload
    @staticmethod
    def shear_mat(shear: Vec3f, cs: _CoordinateSystem = ...) -> LMatrix4f:
        """Returns a matrix that applies the indicated shear in each of the three
        planes.
        """
    @overload
...
class LMatrix3d:
    ...
    def __iadd__(self: Self, other: LMatrix3d) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self: Self, other: LMatrix3d) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    @overload
    def __imul__(self: Self, other: LMatrix3d) -> Self:
        """Performs a memberwise scale."""
    @overload
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self:
...
class LMatrix4d:
    ...
    @overload
    def __init__(self, upper3: LMatrix3d, trans: Vec3d) -> None: ...
    @overload
    ...
    def __ne__(self, __other: object) -> bool: ...
    @overload
    def __mul__(self, other: Mat4d) -> LMatrix4d: ...
    @overload
    def __mul__(self, scalar: float) -> LMatrix4d: ...
    def __truediv__(self, scalar: float) -> LMatrix4d: ...
    def __iadd__(self: Self, other: Mat4d) -> Self:
        """Performs a memberwise addition between two matrices."""
    def __isub__(self: Self, other: Mat4d) -> Self:
        """Performs a memberwise subtraction between two matrices."""
    @overload
    def __imul__(self: Self, other: Mat4d) -> Self: ...
    @overload
    def __imul__(self: Self, scalar: float) -> Self: ...
    def __itruediv__(self: Self, scalar: float) -> Self: ...
    def __le__(self, other: Mat4d) -> bool: ...
    @overload
    def assign(self, other: Mat4d) -> LMatrix4d: ...
    @overload
    ...
    def transpose_in_place(self) -> None: ...
    def invert_from(self, other: Mat4d) -> bool:
        """Computes the inverse of the other matrix, and stores the result in this
        matrix.  This is a fully general operation and makes no assumptions about
        the type of transform represented by the matrix.
    ...
    @staticmethod
    def rotate_mat(angle: float, axis: Vec3d, cs: _CoordinateSystem = ...) -> LMatrix4d:
        """Returns a matrix that rotates by the given angle in degrees
        counterclockwise about the indicated vector.
        """
    @staticmethod
    ...
    @overload
    @staticmethod
    def shear_mat(shear: Vec3d, cs: _CoordinateSystem = ...) -> LMatrix4d:
        """Returns a matrix that applies the indicated shear in each of the three
        planes.
        """
    @overload
...
class LQuaternionf(LVecBase4f):
    ...
    def __init__(self, copy: Vec4f = ...) -> None: ...
    @overload
    def __init__(self, r: float, copy: Vec3f) -> None: ...
    @overload
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    def __neg__(self) -> LQuaternionf: ...
    def __add__(self, other: Vec4f) -> LQuaternionf: ...
    def __sub__(self, other: Vec4f) -> LQuaternionf: ...
    @overload  # type: ignore[override]
    def __mul__(self, __param0: LMatrix3f) -> LMatrix3f: ...
    @overload
    def __mul__(self, __param0: Mat4f) -> LMatrix4f: ...
    @overload
    def __mul__(self, __param0: Vec4f) -> LQuaternionf: ...
    @overload
    def __mul__(self, scalar: float) -> LQuaternionf: ...
    def __truediv__(self, scalar: float) -> LQuaternionf: ...
    def __imul__(self: Self, __param0: Vec4f) -> Self: ...  # type: ignore[misc, override]
    ...
    def conjugate_from(self, other: Vec4f) -> bool:
...
class LQuaterniond(LVecBase4d):
    ...
    def __init__(self, copy: Vec4d = ...) -> None: ...
    @overload
    def __init__(self, r: float, copy: Vec3d) -> None: ...
    @overload
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    def __neg__(self) -> LQuaterniond: ...
    def __add__(self, other: Vec4d) -> LQuaterniond: ...
    def __sub__(self, other: Vec4d) -> LQuaterniond: ...
    @overload  # type: ignore[override]
    def __mul__(self, __param0: LMatrix3d) -> LMatrix3d: ...
    @overload
    def __mul__(self, __param0: Mat4d) -> LMatrix4d: ...
    @overload
    def __mul__(self, __param0: Vec4d) -> LQuaterniond: ...
    @overload
    def __mul__(self, scalar: float) -> LQuaterniond: ...
    def __truediv__(self, scalar: float) -> LQuaterniond: ...
    def __imul__(self: Self, __param0: Vec4d) -> Self: ...  # type: ignore[misc, override]
    ...
    def set_j(self, j: float) -> None: ...
    def set_k(self, k: float) -> None: ...
    def conjugate_from(self, other: Vec4d) -> bool:
        """Computes the conjugate of the other quat, and stores the result in this
        quat.  This is a fully general operation and makes no assumptions about the
        type of transform represented by the quat.
...
class LRotationf(LQuaternionf):
    ...
    def __init__(self, copy: Vec4f) -> None: ...
    @overload
    def __init__(self, axis: Vec3f, angle: float) -> None: ...
    @overload
    ...
    @overload
    def __mul__(self, other: Vec4f) -> LQuaternionf: ...
    @overload
...
class LRotationd(LQuaterniond):
    ...
    def __init__(self, copy: Vec4d) -> None: ...
    @overload
    def __init__(self, axis: Vec3d, angle: float) -> None: ...
    @overload
    def __init__(self, h: float, p: float, r: float) -> None: ...
    @overload
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    ...
    @overload
    def __mul__(self, other: Vec4d) -> LQuaterniond: ...
    @overload
...
class LOrientationf(LQuaternionf):
    ...
    def __init__(self, m: LMatrix3f | Mat4f) -> None: ...
    @overload
    def __init__(self, point_at: Vec3f, twist: float) -> None: ...
    @overload
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    def __mul__(self, other: Vec4f) -> LOrientationf: ...  # type: ignore[override]
...
class LOrientationd(LQuaterniond):
    ...
    def __init__(self, m: LMatrix3d | Mat4d) -> None: ...
    @overload
    def __init__(self, point_at: Vec3d, twist: float) -> None: ...
    @overload
    def __init__(self, r: float, i: float, j: float, k: float) -> None: ...
    def __mul__(self, other: Vec4d) -> LOrientationd: ...  # type: ignore[override]
...
@overload
def __mul__(m: LMatrix3d, q: Vec4d) -> LMatrix3d: ...
@overload
def __mul__(m: LMatrix3f, q: Vec4f) -> LMatrix3f: ...
@overload
def __mul__(m: Mat4d, q: Vec4d) -> LMatrix4d: ...
@overload
def __mul__(m: Mat4f, q: Vec4f) -> LMatrix4f: ...
@overload
def __mul__(v: LVecBase2d, m: LMatrix3d) -> LPoint2d | LVector2d: ...
@overload
def __mul__(v: LVecBase2f, m: LMatrix3f) -> LPoint2f | LVector2f: ...
@overload
def __mul__(v: Vec3d, m: Mat4d) -> LPoint3d | LVector3d: ...
@overload
def __mul__(v: Vec3f, m: Mat4f) -> LPoint3f | LVector3f: ...
@overload
def __mul__(v: Vec3d, m: LMatrix3d) -> LVecBase3d: ...
@overload
def __mul__(v: Vec3f, m: LMatrix3f) -> LVecBase3f: ...
@overload
def __mul__(v: Vec4d, m: Mat4d) -> LVecBase4d: ...
@overload
def __mul__(v: Vec4f, m: Mat4f) -> LVecBase4f: ...
@overload
def __imul__(v: LPoint3d | LVecBase2d | LVector3d | Vec3d, m: LMatrix3d) -> None: ...
@overload
def __imul__(v: LPoint3f | LVecBase2f | LVector3f | Vec3f, m: LMatrix3f) -> None: ...
@overload
def __imul__(v: Vec3d | Vec4d, m: Mat4d) -> None: ...
@overload
def __imul__(v: Vec3f | Vec4f, m: Mat4f) -> None: ...
...
@overload
def transpose(a: Mat4d) -> LMatrix4d: ...
@overload
def transpose(a: Mat4f) -> LMatrix4f: ...
@overload
def invert(a: LMatrix3d) -> LMatrix3d: ...
@overload
def invert(a: LMatrix3f) -> LMatrix3f: ...
@overload
def invert(a: Mat4d) -> LMatrix4d: ...
@overload
def invert(a: Mat4f) -> LMatrix4f: ...
@overload
def invert(a: Vec4d) -> LQuaterniond: ...
@overload
def invert(a: Vec4f) -> LQuaternionf: ...
def generic_write_datagram(dest: Datagram, value: LMatrix3d | LMatrix3f | Mat4d | Mat4f) -> None: ...
def generic_read_datagram(result: LMatrix3d | LMatrix3f | Mat4d | Mat4f, source: DatagramIterator) -> None: ...
@overload
def compose_matrix(mat: LMatrix3d, scale: Vec3d, hpr: Vec3d, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: LMatrix3f, scale: Vec3f, hpr: Vec3f, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: LMatrix3d, scale: Vec3d, shear: Vec3d, hpr: Vec3d, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: LMatrix3f, scale: Vec3f, shear: Vec3f, hpr: Vec3f, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: Mat4d, scale: Vec3d, hpr: Vec3d, translate: Vec3d, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: Mat4f, scale: Vec3f, hpr: Vec3f, translate: Vec3f, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: Mat4d, scale: Vec3d, shear: Vec3d, hpr: Vec3d, translate: Vec3d, cs: _CoordinateSystem = ...) -> None: ...
@overload
def compose_matrix(mat: Mat4f, scale: Vec3f, shear: Vec3f, hpr: Vec3f, translate: Vec3f, cs: _CoordinateSystem = ...) -> None: ...
@overload
def decompose_matrix(mat: LMatrix3d, scale: Vec3d, hpr: Vec3d, cs: _CoordinateSystem = ...) -> bool: ...
@overload
def decompose_matrix(mat: LMatrix3f, scale: Vec3f, hpr: Vec3f, cs: _CoordinateSystem = ...) -> bool: ...
@overload
def decompose_matrix(mat: LMatrix3d, scale: Vec3d, shear: Vec3d, hpr: Vec3d, cs: _CoordinateSystem = ...) -> bool: ...
@overload
def decompose_matrix(mat: LMatrix3f, scale: Vec3f, shear: Vec3f, hpr: Vec3f, cs: _CoordinateSystem = ...) -> bool: ...
@overload
def decompose_matrix(mat: Mat4d, scale: Vec3d, hpr: Vec3d, translate: Vec3d, cs: _CoordinateSystem = ...) -> bool: ...
@overload
...
@overload
def decompose_matrix_old_hpr(mat: LMatrix3f, scale: Vec3f, shear: Vec3f, hpr: Vec3f, cs: _CoordinateSystem = ...) -> bool: ...
@overload
