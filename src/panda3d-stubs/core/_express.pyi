...
class ConstPointerToArray_double(PointerToArrayBase_double):
    def __init__(self, copy: ConstPointerToArray_double | PointerToArray_double | TypeHandle | type) -> None: ...
...
class ConstPointerToArray_float(PointerToArrayBase_float):
    def __init__(self, copy: ConstPointerToArray_float | PointerToArray_float | TypeHandle | type) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> float: ...
...
class ConstPointerToArray_int(PointerToArrayBase_int):
    def __init__(self, copy: ConstPointerToArray_int | PointerToArray_int | TypeHandle | type) -> None: ...
    def __len__(self) -> int: ...
...
class ConstPointerToArray_unsigned_char(PointerToArrayBase_unsigned_char):
    def __init__(self, copy: ConstPointerToArray_unsigned_char | PointerToArray_unsigned_char | TypeHandle | type) -> None: ...
    def __len__(self) -> int: ...
...
class PointerToArray_double(PointerToArrayBase_double):
    ...
    @overload
    def __init__(self, copy: PointerToArray_double | TypeHandle | type) -> None: ...
    @overload
...
class PointerToArray_float(PointerToArrayBase_float):
    ...
    def __init__(self, type_handle: TypeHandle | type = ...) -> None: ...
    @overload
    def __init__(self, copy: PointerToArray_float | TypeHandle | type) -> None: ...
    @overload
    def __init__(self, source: Sequence[float]) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> float: ...
...
class PointerToArray_int(PointerToArrayBase_int):
    ...
    def __init__(self, type_handle: TypeHandle | type = ...) -> None: ...
    @overload
    def __init__(self, copy: PointerToArray_int | TypeHandle | type) -> None: ...
    @overload
...
class PointerToArray_unsigned_char(PointerToArrayBase_unsigned_char):
    ...
    def __init__(self, type_handle: TypeHandle | type = ...) -> None: ...
    @overload
    def __init__(self, copy: PointerToArray_unsigned_char | TypeHandle | type) -> None: ...
    @overload
...
class Datagram(TypedObject):
    ...
    def set_array(self, data: PTA_uchar | TypeHandle | type) -> None:
        ...
        """
    def copy_array(self, data: CPTA_uchar | PointerToArray_unsigned_char | TypeHandle | type) -> None:
...
class DatagramIterator:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, __param0: Datagram | DatagramIterator = ...) -> None: ...
    @overload
...
class FileReference(TypedReferenceCount):
    ...
    @overload
    def __init__(self, __param0: FileReference | StrOrBytesPath) -> None: ...
    @overload
...
class SubfileInfo:
    ...
    @overload
    def __init__(self, file: FileReference | StrOrBytesPath, start: int, size: int) -> None: ...
    @overload
