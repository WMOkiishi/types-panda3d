...
class ShaderInput:
    ...
    @overload
    def __init__(self, param0: ShaderInput, /) -> None: ...
...
class NodePath(Generic[_N]):
    ...
    def set_pos_hpr_scale_shear(self, pos: Vec3Like, hpr: Vec3Like, scale: Vec3Like, shear: Vec3Like) -> None:
        ...
        """
    @overload
    def set_pos_hpr_scale_shear(self, other: NodePath, pos: Vec3Like, hpr: Vec3Like, scale: Vec3Like, shear: Vec3Like) -> None:
        """Completely replaces the transform with new translation, rotation, scale,
    ...
    def set_pos_quat_scale_shear(self, pos: Vec3Like, quat: Vec4Like, scale: Vec3Like, shear: Vec3Like) -> None:
        ...
        """
    @overload
    def set_pos_quat_scale_shear(self, other: NodePath, pos: Vec3Like, quat: Vec4Like, scale: Vec3Like, shear: Vec3Like) -> None:
        """Completely replaces the transform with new translation, rotation, scale,
        and shear components, relative to the other node.
        """
    @overload
    ...
    @overload
    def set_shader_input(self, param0: InternalName | str, param1, /, priority: int = ...) -> None: ...
    @overload
...
class ClipPlaneAttrib(RenderAttrib):
    ...
    @overload
    @staticmethod
    def make(op: _ClipPlaneAttrib_Operation, plane1: PlaneNode, plane2: PlaneNode, plane3: PlaneNode = ...) -> ClipPlaneAttrib:
...
class CullBinEnums:
    ...
    BTFixed: Final = 5
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: CullBinEnums = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class Loader(TypedReferenceCount, Namable):
    ...
    @overload
    def __init__(self, param0: Loader, /) -> None: ...
    @overload
    def __init__(self, name: str = ...) -> None: ...
...
class ModelRoot(ModelNode):
    ...
    class ModelReference(ReferenceCount):
        ...
        DtoolClassDict: ClassVar[dict[str, Any]]
        def __init__(self, param0: ModelRoot.ModelReference = ..., /) -> None: ...
        def __copy__(self) -> Self: ...
        def __deepcopy__(self, memo: object, /) -> Self: ...
...
class PolylightNode(PandaNode):
    ...
    AQUADRATIC: Final = 1
    @overload
    def __init__(self, param0: PolylightNode, /) -> None: ...
    @overload
    def __init__(self, name: str) -> None:
...
class ShaderAttrib(RenderAttrib):
    ...
    @overload
    def set_shader_input(self, param0: InternalName | str, param1, /, priority: int = ...) -> Self: ...
    @overload
