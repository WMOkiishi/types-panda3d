...
class PandaNode(TypedWritableReferenceCount, Namable):
    ...
    def set_python_tag(self, key, value) -> None: ...
    def get_python_tag(self, key): ...
    def has_python_tag(self, key) -> bool: ...
    def clear_python_tag(self, key) -> None: ...
...
class NodePath(Generic[_N]):
    ...
    def __init__(self, copy: NodePath = ...) -> None:
        ...
        ...
    @overload
    def __init__(self, node: NodePath[_N], current_thread: Thread = ...) -> None: ...
    @overload
    def __init__(self, top_node_name: _N, current_thread: Thread = ...) -> None: ...
    @overload
    ...
    def set_python_tag(self, keys, value) -> None: ...
    def get_python_tag(self, keys): ...
    def get_python_tag_keys(self): ...
    def has_python_tag(self, keys) -> bool: ...
    def clear_python_tag(self, keys) -> None: ...
    def get_net_python_tag(self, keys): ...
    def has_net_python_tag(self, keys) -> bool: ...
    def find_net_python_tag(self, keys) -> NodePath: ...
