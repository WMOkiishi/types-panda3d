...
class ConstPointerToArray_LVecBase3d(PointerToArrayBase_LVecBase3d):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Vec3d) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase3f(PointerToArrayBase_LVecBase3f):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Vec3f) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLMatrix4d(PointerToArrayBase_UnalignedLMatrix4d):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Mat4d) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLMatrix4f(PointerToArrayBase_UnalignedLMatrix4f):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Mat4f) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4d(PointerToArrayBase_UnalignedLVecBase4d):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Vec4d) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4f(PointerToArrayBase_UnalignedLVecBase4f):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Vec4f) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4i(PointerToArrayBase_UnalignedLVecBase4i):
    ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, __param0: Vec4i) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class PointerToArray_LVecBase3d(PointerToArrayBase_LVecBase3d):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> LVecBase3d: ...
    def __setitem__(self, n: int, value: Vec3d) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_LVecBase3d: ...
    def push_back(self, x: Vec3d) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> LVecBase3d: ...
    def set_element(self, n: int, value: Vec3d) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_LVecBase3f(PointerToArrayBase_LVecBase3f):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> LVecBase3f: ...
    def __setitem__(self, n: int, value: Vec3f) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_LVecBase3f: ...
    def push_back(self, x: Vec3f) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> LVecBase3f: ...
    def set_element(self, n: int, value: Vec3f) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_UnalignedLMatrix4d(PointerToArrayBase_UnalignedLMatrix4d):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> UnalignedLMatrix4d: ...
    def __setitem__(self, n: int, value: Mat4d) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_UnalignedLMatrix4d: ...
    def push_back(self, x: Mat4d) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> UnalignedLMatrix4d: ...
    def set_element(self, n: int, value: Mat4d) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_UnalignedLMatrix4f(PointerToArrayBase_UnalignedLMatrix4f):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> UnalignedLMatrix4f: ...
    def __setitem__(self, n: int, value: Mat4f) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_UnalignedLMatrix4f: ...
    def push_back(self, x: Mat4f) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> UnalignedLMatrix4f: ...
    def set_element(self, n: int, value: Mat4f) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_UnalignedLVecBase4d(PointerToArrayBase_UnalignedLVecBase4d):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> UnalignedLVecBase4d: ...
    def __setitem__(self, n: int, value: Vec4d) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_UnalignedLVecBase4d: ...
    def push_back(self, x: Vec4d) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> UnalignedLVecBase4d: ...
    def set_element(self, n: int, value: Vec4d) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_UnalignedLVecBase4f(PointerToArrayBase_UnalignedLVecBase4f):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> UnalignedLVecBase4f: ...
    def __setitem__(self, n: int, value: Vec4f) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_UnalignedLVecBase4f: ...
    def push_back(self, x: Vec4f) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> UnalignedLVecBase4f: ...
    def set_element(self, n: int, value: Vec4f) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
class PointerToArray_UnalignedLVecBase4i(PointerToArrayBase_UnalignedLVecBase4i):
    ...
    def __len__(self) -> int: ...
    def __getitem__(self, n: int) -> UnalignedLVecBase4i: ...
    def __setitem__(self, n: int, value: Vec4i) -> None: ...
    @staticmethod
    def empty_array(n: int, type_handle: TypeHandle = ...) -> PointerToArray_UnalignedLVecBase4i: ...
    def push_back(self, x: Vec4i) -> None: ...
    def pop_back(self) -> None: ...
    def get_element(self, n: int) -> UnalignedLVecBase4i: ...
    def set_element(self, n: int, value: Vec4i) -> None: ...
    def get_data(self) -> bytes: ...
    def set_data(self, data) -> None: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def set_subdata(self, n: int, count: int, data: str) -> None: ...
...
@overload
def heads_up(mat: LMatrix3d | Mat4d, fwd: Vec3d, up: Vec3d = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def heads_up(mat: LMatrix3f | Mat4f, fwd: Vec3f, up: Vec3f = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def heads_up(quat: Vec4d, fwd: Vec3d, up: Vec3d = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def heads_up(quat: Vec4f, fwd: Vec3f, up: Vec3f = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def heads_up(mat: LMatrix3d | Mat4d, fwd: Vec3d, cs: _CoordinateSystem) -> None: ...
@overload
def heads_up(mat: LMatrix3f | Mat4f, fwd: Vec3f, cs: _CoordinateSystem) -> None: ...
@overload
def heads_up(quat: Vec4d, fwd: Vec3d, cs: _CoordinateSystem) -> None: ...
@overload
def heads_up(quat: Vec4f, fwd: Vec3f, cs: _CoordinateSystem) -> None: ...
@overload
def look_at(mat: LMatrix3d | Mat4d, fwd: Vec3d, up: Vec3d = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def look_at(mat: LMatrix3f | Mat4f, fwd: Vec3f, up: Vec3f = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def look_at(quat: Vec4d, fwd: Vec3d, up: Vec3d = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def look_at(quat: Vec4f, fwd: Vec3f, up: Vec3f = ..., cs: _CoordinateSystem = ...) -> None: ...
@overload
def look_at(mat: LMatrix3d | Mat4d, fwd: Vec3d, cs: _CoordinateSystem) -> None: ...
@overload
def look_at(mat: LMatrix3f | Mat4f, fwd: Vec3f, cs: _CoordinateSystem) -> None: ...
@overload
def look_at(quat: Vec4d, fwd: Vec3d, cs: _CoordinateSystem) -> None: ...
@overload
def look_at(quat: Vec4f, fwd: Vec3f, cs: _CoordinateSystem) -> None: ...
@overload
