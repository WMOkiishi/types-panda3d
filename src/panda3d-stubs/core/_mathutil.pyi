...
class ConstPointerToArray_LMatrix3f(PointerToArrayBase_LMatrix3f):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LMatrix3f]: ...
    def get_element(self, n: int, /) -> LMatrix3f: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: LMatrix3f, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase2d(PointerToArrayBase_LVecBase2d):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase2d]: ...
    def get_element(self, n: int, /) -> LVecBase2d: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: DoubleVec2Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase2f(PointerToArrayBase_LVecBase2f):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase2f]: ...
    def get_element(self, n: int, /) -> LVecBase2f: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: Vec2Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase2i(PointerToArrayBase_LVecBase2i):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase2i]: ...
    def get_element(self, n: int, /) -> LVecBase2i: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: IntVec2Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase3d(PointerToArrayBase_LVecBase3d):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase3d]: ...
    def get_element(self, n: int, /) -> LVecBase3d: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: DoubleVec3Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase3f(PointerToArrayBase_LVecBase3f):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase3f]: ...
    def get_element(self, n: int, /) -> LVecBase3f: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: Vec3Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_LVecBase3i(PointerToArrayBase_LVecBase3i):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[LVecBase3i]: ...
    def get_element(self, n: int, /) -> LVecBase3i: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: IntVec3Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLMatrix4d(PointerToArrayBase_UnalignedLMatrix4d):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[UnalignedLMatrix4d]: ...
    def get_element(self, n: int, /) -> UnalignedLMatrix4d: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: DoubleMat4Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLMatrix4f(PointerToArrayBase_UnalignedLMatrix4f):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[UnalignedLMatrix4f]: ...
    def get_element(self, n: int, /) -> UnalignedLMatrix4f: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: Mat4Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4d(PointerToArrayBase_UnalignedLVecBase4d):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[UnalignedLVecBase4d]: ...
    def get_element(self, n: int, /) -> UnalignedLVecBase4d: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: DoubleVec4Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4f(PointerToArrayBase_UnalignedLVecBase4f):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[UnalignedLVecBase4f]: ...
    def get_element(self, n: int, /) -> UnalignedLVecBase4f: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: Vec4Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class ConstPointerToArray_UnalignedLVecBase4i(PointerToArrayBase_UnalignedLVecBase4i):
    ...
    def __copy__(self) -> Self: ...
    @type_check_only
    def __iter__(self) -> Iterator[UnalignedLVecBase4i]: ...
    def get_element(self, n: int, /) -> UnalignedLVecBase4i: ...
    def get_data(self) -> bytes: ...
    def get_subdata(self, n: int, count: int) -> bytes: ...
    def get_ref_count(self) -> int: ...
    def get_node_ref_count(self) -> int: ...
    def count(self, param0: IntVec4Like, /) -> int: ...
    getElement = get_element
    getData = get_data
    getSubdata = get_subdata
    getRefCount = get_ref_count
...
class LFrustumf:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: LFrustumf = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @overload
...
class LFrustumd:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: LFrustumd = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @overload
    def make_ortho_2D(self) -> None:
...
class Mersenne:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: Mersenne, /) -> None: ...
    @overload
...
class Triangulator:
    ...
    def __init__(self, param0: Triangulator = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def clear(self) -> None:
