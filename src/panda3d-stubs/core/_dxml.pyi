...
class TiXmlElement(TiXmlNode):
    ...
    @overload
    def __init__(self, param0: TiXmlElement, /) -> None: ...
    @overload
...
class TiXmlCursor:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: TiXmlCursor, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class TiXmlVisitor:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: TiXmlVisitor = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @overload
    def VisitEnter(self, param0: TiXmlDocument | str, /) -> bool:
        """doc"""
    @overload
    def VisitEnter(self, param0: TiXmlElement | str, param1: TiXmlAttribute, /) -> bool:
        """firstAttribute"""
    def VisitExit(self, param0: TiXmlDocument | TiXmlElement | str, /) -> bool:
        """doc

        or:
        element
        """
    def Visit(self, param0: TiXmlComment | TiXmlDeclaration | TiXmlText | TiXmlUnknown | str, /) -> bool:
        """comment
...
class TiXmlComment(TiXmlNode):
    ...
    @overload
    def __init__(self, param0: TiXmlComment = ..., /) -> None:
