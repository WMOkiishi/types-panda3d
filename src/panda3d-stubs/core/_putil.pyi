...
class BamCacheRecord(TypedWritableReferenceCount):
    ...
    def add_dependent_file(self, pathname_or_file: StrOrBytesPath | VirtualFile, /) -> None:
...
class BamEnums:
    ...
    BTMRawdata: Final = 4
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: BamEnums = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class LoaderOptions:
    ...
    @overload
    def __init__(self, param0: LoaderOptions, /) -> None: ...
    @overload
...
class BitMask_uint16_t_16:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: BitMask_uint16_t_16 = ..., /) -> None: ...
    @overload
    ...
    def keep_next_highest_bit(self, other_or_index: BitMask_uint16_t_16 | int = ..., /) -> BitMask_uint16_t_16: ...
    def keep_next_lowest_bit(self, other_or_index: BitMask_uint16_t_16 | int = ..., /) -> BitMask_uint16_t_16: ...
...
class BitMask_uint32_t_32:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: BitMask_uint32_t_32 = ..., /) -> None: ...
    @overload
    def __init__(self, init_value: int) -> None: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    ...
    def keep_next_highest_bit(self, other_or_index: BitMask_uint32_t_32 | int = ..., /) -> BitMask_uint32_t_32: ...
    def keep_next_lowest_bit(self, other_or_index: BitMask_uint32_t_32 | int = ..., /) -> BitMask_uint32_t_32: ...
    def get_key(self) -> int: ...
    @staticmethod
    def get_class_type() -> TypeHandle: ...
    allOn = all_on
...
class BitMask_uint64_t_64:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: BitMask_uint64_t_64 = ..., /) -> None: ...
    @overload
    def __init__(self, init_value: int) -> None: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
    ...
    def keep_next_highest_bit(self, other_or_index: BitMask_uint64_t_64 | int = ..., /) -> BitMask_uint64_t_64: ...
    def keep_next_lowest_bit(self, other_or_index: BitMask_uint64_t_64 | int = ..., /) -> BitMask_uint64_t_64: ...
    def get_key(self) -> int: ...
    @staticmethod
    def get_class_type() -> TypeHandle: ...
    allOn = all_on
...
class ButtonHandle:
    ...
    @overload
    def __init__(self, param0: ButtonHandle = ..., /) -> None:
...
class ButtonRegistry:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: ButtonRegistry, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class ButtonMap(TypedReferenceCount):
    ...
    def __init__(self, param0: ButtonMap = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    ...
    def get_mapped_button(self, raw_or_i_or_raw_name: ButtonHandle | int | str, /) -> ButtonHandle:
        ...
        given raw button.
        """
    def get_mapped_button_label(self, raw_or_i_or_raw_name: ButtonHandle | int | str, /) -> str:
...
class CallbackObject(TypedReferenceCount):
    ...
    def __init__(self, param0: Callable | CallbackObject, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def output(self, out: ostream, /) -> None: ...
    @staticmethod
...
class PythonCallbackObject(CallbackObject):
    ...
    @overload
    def __init__(self, param0: PythonCallbackObject, /) -> None: ...
...
class TimeVal:
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: TimeVal = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class DoubleBitMask_BitMaskNative:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: DoubleBitMask_BitMaskNative = ..., /) -> None: ...
    @overload
...
class DoubleBitMask_DoubleBitMaskNative:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, param0: DoubleBitMask_DoubleBitMaskNative = ..., /) -> None: ...
    @overload
    def __init__(self, init_value) -> None: ...
    def __eq__(self, other: object, /) -> bool: ...
    def __ne__(self, other: object, /) -> bool: ...
...
class GamepadButton:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: GamepadButton = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class KeyboardButton:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: KeyboardButton = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
...
class ModifierButtons:
    ...
    def is_down(self, button_or_index: ButtonHandle | int | str, /) -> bool:
...
class MouseButton:
    ...
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: MouseButton = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @staticmethod
