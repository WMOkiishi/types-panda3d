...
class ConstPointerToArray_ushort(PointerToArrayBase_ushort):
    def __init__(self, copy: ConstPointerToArray_ushort | PointerToArray_ushort | TypeHandle | type) -> None: ...
...
class PointerToArray_ushort(PointerToArrayBase_ushort):
    ...
    @overload
    def __init__(self, copy: PointerToArray_ushort | TypeHandle | type) -> None: ...
    @overload
...
class BitMask_uint16_t_16:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, __param0: BitMask_uint16_t_16 | int = ...) -> None: ...
    @overload
    ...
    @overload
    def keep_next_highest_bit(self, other: BitMask_uint16_t_16 | int = ...) -> BitMask_uint16_t_16: ...
    @overload
    def keep_next_highest_bit(self, index: int) -> BitMask_uint16_t_16: ...
    @overload
    def keep_next_lowest_bit(self, other: BitMask_uint16_t_16 | int = ...) -> BitMask_uint16_t_16: ...
    @overload
...
class BitMask_uint32_t_32:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, __param0: BitMask_uint32_t_32 | int = ...) -> None: ...
    @overload
    def __init__(self, init_value: int) -> None: ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    ...
    @overload
    def keep_next_highest_bit(self, other: BitMask_uint32_t_32 | int = ...) -> BitMask_uint32_t_32: ...
    @overload
    def keep_next_highest_bit(self, index: int) -> BitMask_uint32_t_32: ...
    @overload
    def keep_next_lowest_bit(self, other: BitMask_uint32_t_32 | int = ...) -> BitMask_uint32_t_32: ...
    @overload
...
class BitMask_uint64_t_64:
    DtoolClassDict: ClassVar[dict[str, Any]]
    @overload
    def __init__(self, __param0: BitMask_uint64_t_64 | int = ...) -> None: ...
    @overload
    def __init__(self, init_value: int) -> None: ...
    def __eq__(self, __other: object) -> bool: ...
    def __ne__(self, __other: object) -> bool: ...
    ...
    @overload
    def keep_next_highest_bit(self, other: BitMask_uint64_t_64 | int = ...) -> BitMask_uint64_t_64: ...
    @overload
    def keep_next_highest_bit(self, index: int) -> BitMask_uint64_t_64: ...
    @overload
    def keep_next_lowest_bit(self, other: BitMask_uint64_t_64 | int = ...) -> BitMask_uint64_t_64: ...
    @overload
...
class ButtonHandle:
    ...
    @overload
    def __init__(self, __param0: ButtonHandle | int | str = ...) -> None:
        """`(self)`:
...
class ButtonMap(TypedReferenceCount):
    ...
    @overload
    def get_mapped_button(self, raw: ButtonHandle | int | str) -> ButtonHandle:
    ...
    @overload
    def get_mapped_button_label(self, raw: ButtonHandle | int | str) -> str:
        """`(self, raw: ButtonHandle)`; `(self, raw_name: str)`:
...
class ClockObject(ReferenceCount):
    ...
    @overload
    def __init__(self, copy: ClockObject | _ClockObject_Mode) -> None: ...
...
class DatagramInputFile(DatagramGenerator):
    ...
    def __init__(self) -> None: ...
    @overload
    def open(self, file: FileReference | StrOrBytesPath) -> bool:
...
class ModifierButtons:
    ...
    @overload
    def is_down(self, button: ButtonHandle | int | str) -> bool:
...
class SparseArray:
    ...
    def __ne__(self, __other: object) -> bool: ...
    def __lt__(self, other: BitArray | SparseArray | int) -> bool: ...
    def __and__(self, other: BitArray | SparseArray | int) -> SparseArray: ...
    def __or__(self, other: BitArray | SparseArray | int) -> SparseArray: ...
    def __xor__(self, other: BitArray | SparseArray | int) -> SparseArray: ...
