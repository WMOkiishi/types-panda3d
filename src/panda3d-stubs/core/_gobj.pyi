...
class GeomEnums:
    ...
    ATHardware: Final = 2
    DtoolClassDict: ClassVar[dict[str, Any]]
    def __init__(self, param0: GeomEnums = ..., /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
...
class GeomVertexFormat(TypedWritableReferenceCount, GeomEnums):
    ...
    def get_num_columns(self) -> int:
        ...
        all arrays.
        """
    def get_array_with(self, name_or_i: InternalName | int | str, /) -> int:
        ...
        get_data() or set_data() to manipulate the actual array data.
        """
    def get_column(self, name_or_i: InternalName | int | str, /) -> GeomVertexColumn:
        """Returns the specification with the indicated name, or NULL if the name is
...
class TransformBlend:
    ...
    def add_transform(self, transform: VertexTransform, weight: float) -> None:
        ...
        """
    def remove_transform(self, transform_or_n: VertexTransform | int, /) -> None:
    ...
    def get_weight(self, transform_or_n: VertexTransform | int, /) -> float:
...
class TextureStage(TypedWritableReferenceCount):
    ...
    def get_priority(self) -> int:
        ...
        of multi-texturing.
        """
    def set_texcoord_name(self, name_or_texcoord_name: InternalName | str, /) -> None:
...
class SamplerState:
    ...
    def __init__(self, param0: SamplerState = ..., /) -> None:
...
class Shader(TypedWritableReferenceCount):
    ...
    def __init__(self, param0: Shader, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    @overload
    @staticmethod
...
class ShaderBuffer(TypedWritableReferenceCount, Namable, GeomEnums):
    ...
    def usage_hint(self) -> _GeomEnums_UsageHint: ...
    @overload
    def __init__(self, param0: ShaderBuffer, /) -> None: ...
    @overload
...
class PreparedGraphicsObjects(ReferenceCount):
    ...
    def release_texture(self, tex_or_tc: Texture | TextureContext, /) -> None:
...
class TexturePeeker(ReferenceCount):
    ...
    def __init__(self, param0: TexturePeeker, /) -> None: ...
    def __copy__(self) -> Self: ...
    def __deepcopy__(self, memo: object, /) -> Self: ...
    def get_x_size(self) -> int:
