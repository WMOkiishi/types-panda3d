...
RETURN_TYPE_OVERRIDES: Final = TrackingMap[str, str | dict[int, str]]({
    ...
    'LRotationd::operator *': {0: 'LRotationd'},
    'LRotationf::operator *': {0: 'LRotationf'},
...
# Comments to add
COMMENTS: Final = TrackingMap[str | tuple[str, int], str]({
    'CallbackGraphicsWindow::EventsCallbackData': 'noqa: F821',
    'CallbackGraphicsWindow::PropertiesCallbackData': 'noqa: F821',
    'CallbackGraphicsWindow::RenderCallbackData': 'noqa: F821',
    'Character::get_bundle': 'pyright: ignore[reportIncompatibleMethodOverride]',
    ('GeometricBoundingVolume::contains', 2): 'pyright: ignore[reportIncompatibleMethodOverride]',
    ('GeometricBoundingVolume::extend_by', 1): 'pyright: ignore[reportIncompatibleMethodOverride]',
    'GeomVertexRewriter::operator =': 'type: ignore[override]',
    ('EggComment::operator =', 1): 'pyright: ignore[reportIncompatibleMethodOverride]',
    'EggVertex::compare_to': 'pyright: ignore[reportIncompatibleMethodOverride]',
    'EggVertex::operator =': 'pyright: ignore[reportIncompatibleMethodOverride]',
    'EggXfmSAnim::operator =': 'pyright: ignore[reportIncompatibleMethodOverride]',
    'EggXfmAnimData::operator =': 'pyright: ignore[reportIncompatibleMethodOverride]',
    'HTTPDate::operator -=': 'type: ignore[misc]',
    'LOrientationd::operator *': 'type: ignore[override]',
    'LOrientationf::operator *': 'type: ignore[override]',
    'LPlaned::operator *=': 'type: ignore[override]',
    'LPlaned::operator *': 'type: ignore[override]',
    'LPlaned::project': 'type: ignore[override]',
    ...
    'TextNode::set_transform': 'type: ignore[override]',
    'TextNode::transform': 'type: ignore[assignment]',
    'TrackerNode::get_transform': 'type: ignore[override]',
    'Triangulator3::add_vertex': 'type: ignore[override]',
    ('Triangulator3::add_vertex', 1): 'pyright: ignore[reportIncompatibleMethodOverride]',
    'Triangulator3::get_vertex': 'type: ignore[override]',
    'Triangulator3::get_vertices': 'type: ignore[override]',
    'Triangulator3::vertices': 'type: ignore[override]',
    'TypedReferenceCount': 'type: ignore[misc]',
    'VertexDataPage::alloc': 'type: ignore[override]',
    'VertexDataPage::write': 'type: ignore[override]',
    'EggData::recompute_polygon_normals': 'type: ignore[override]',
    'EggData::recompute_vertex_normals': 'type: ignore[override]',
    'EggGroup::write': 'type: ignore[override]',
    'EggTexture::write': 'type: ignore[override]',
})
