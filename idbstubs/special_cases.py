...
COMMENTS: Final = TrackingMap[str | tuple[str, int], str]({
    'AsyncTask': 'type: ignore[misc]',
    'AsyncTaskSequence': 'type: ignore[misc]',
    ...
    'DatagramBuffer': 'type: ignore[misc]',
    'DynamicTextFont': 'type: ignore[misc]',
    'GeomVertexArrayData': 'type: ignore[misc]',
    'GeomVertexRewriter': 'type: ignore[misc]',
    ...
    'ShaderBuffer': 'type: ignore[misc]',
    'Socket_UDP::SendTo': 'type: ignore[override]',
    'SocketStream': 'type: ignore[misc]',
    'SocketStream::flush': 'type: ignore[override]',
    'StreamWrapper': 'type: ignore[misc]',
